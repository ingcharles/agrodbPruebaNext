...
$itemsFiltrados[] = array();
	...
	switch ($tipoSolicitud){
		...
		case 'ImportacionMuestrasVUE' :
		    ...
		    if($_POST['inspectores'] == 'asignar'){
		        $res = $cim -> listarImportacionMuestrasRevisionProvinciaRS($conexion, 'enviado', $provinciaUsuario, $perfilUsuario);
		    }else{
		        $res = $cim -> listarImportacionMuestrasAsignadasInspectorRS($conexion, 'asignadoDocumental', $_POST['inspectores'], 'ImportacionMuestrasVUE', $estado, $provinciaUsuario, $perfilUsuario);
		    }
		    
		    $nombreArchivo = 'abrirImportacionMuestrasEnviada';
