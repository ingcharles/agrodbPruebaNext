		...
		//if(pg_fetch_result($qFinanciero, 0, 'monto') == $montoRecaudado){
			...
			switch ($tipoSolicitud){
				...
				case 'ImportacionMuestrasVUE' :
				    ...
				    $importacion = pg_fetch_assoc($cim->abrirImportacionMuestras($conexion, $idSolicitud));
				    				        
			        //Asigna el resultado de revisión de pago de solicitud de importacion
				    $cim->enviarImportacionMuestras($conexion, $idSolicitud, $resultado);
			        
			        //Asignar fecha de vigencia de solicitud
				    $cim->enviarFechaVigenciaImportacionMuestras($conexion, $idSolicitud ,$importacion['codigo_tipo_solicitud']);
				...
				case 'dossierPecuario':
				    ...
				    $cdpmvc->actualizarEstadoSolicitud($conexion, 'Pagado', $idSolicitud, 'Financiero registró pago de factura');
				    																													  
				    $cdpmvc->ingresarHistoricoEstados($conexion, 'Pagado', $idSolicitud, $_SESSION['usuario'], 'Financiero registró pago de factura');
                ...
                case 'ensayoEficacia':
                    ...
                    $cee->actualizarEstadoSolicitudPorIdSolicitud($conexion, $idSolicitud, 'inspeccion');
				...
				case 'registroProductoRia':
					...
					$crp->actualizarEstadoSolicitudPorIdSolicitud($conexion, $idSolicitud, 'inspeccion');
