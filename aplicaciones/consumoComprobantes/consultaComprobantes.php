...
$identificadorUsuarioRegistro = $_SESSION['usuario'];
	...
	$establecimiento[] = array(numEstablecimiento=>'015',ruc=>'1768188830001');
?>
...
var array_establecimiento= <?php echo json_encode($establecimiento); ?>;
    ...
    $(document).ready(function(){
		...
		sestablecimiento += '<option value="002">002</option>';
		sestablecimiento += '<option value="038">038</option>';
