    ...
    if($id_res != "existe"){
        ...
        if($objArr!=null) {
            ...
            foreach ($objArr as $obj) {
                ...
                $insumo = new ProductoInsumo($ic_producto_insumo_id, $ic_producto_id, $ic_insumo_id, $um, $limite_minimo, $limite_maximo, $ic_lmr_id);
        ...
        if($arr_muestra!=null){
            ...
            if($objArr!=null) {
                ...
                foreach ($objArr as $obj) {
                    ...
                    $limite_maximo = $obj->{'limite_maximo'};
                    $ic_lmr_id = $obj->{'ic_lmr_id'};
                    $muestra_rapida = new ProductoMuestraRapida($ic_producto_muestra_rapida_id, $ic_producto_id, $ic_insumo_id, $um, $limite_minimo, $limite_maximo, $ic_lmr_id);
        ...
        $mensaje['estado'] = 'error';
        $mensaje['mensaje'] = 'El producto ya se encuentra registrado..!'; 
    }
