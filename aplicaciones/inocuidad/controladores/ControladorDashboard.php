...
class ControladorDashboard
{
    ...
    public function listDashboard($usuario){
        ...
        try{
            ...
            $banderaPerfil ="";
            $botonCancelar = "";
            $resPerfil = pg_fetch_assoc($this->servicios->obtenerPerfilUsuario($this->conexion,$_SESSION['usuario']));
            ...
            $items=$this->servicios->getAllDashboard($usuario,$this->conexion,$banderaPerfil);
            /* @var $item Dashboard */
