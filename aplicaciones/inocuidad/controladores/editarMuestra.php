...
try{
    ...
    //Importacion
    $nombre_rep_legal     = isset($_POST['nombre_rep_legal']) && $_POST['nombre_rep_legal'] != '' ?   $_POST['nombre_rep_legal'] :  $_POST['nombre_representante'] ;
    ...
    $ultimo_insumo_aplicado_id = isset($_POST['ultimo_insumo_aplicado_id']) && $_POST['ultimo_insumo_aplicado_id'] !=='' ?   $_POST['ultimo_insumo_aplicado_id'] :   0;
    ...
    $tecnica_muestreo          = isset($_POST['tecnica_muestreo']) && $_POST['tecnica_muestreo'] !=='' ?   $_POST['tecnica_muestreo'] :   0;
    $medio_refrigeracion       = isset($_POST['medio_refrigeracion']) && $_POST['medio_refrigeracion'] !=='' ?   $_POST['medio_refrigeracion'] :   0;
    $observaciones             = isset($_POST['observaciones'])  ?   $_POST['observaciones'] :   null;

    if(isset($_POST['codigoProvincia_id']) && $_POST['codigoProvincia_id'] != ''){
        $provincia_id      =  $_POST['codigoProvincia_id'];
    }else{
        $provincia_id      = isset($_POST['provincia_id']) ? $_POST['provincia_id'] : 0;
    }

    //agregado campos elvis

    $nombre_establecimiento = isset($_POST['nombre_establecimiento'])  ?   $_POST['nombre_establecimiento'] :   null;
    $direccion_establecimiento = isset($_POST['direccion_establecimiento'])  ?   $_POST['direccion_establecimiento'] :   null;
    $certificacion_sanitaria = isset($_POST['certificacion_sanitaria'])  ?   $_POST['certificacion_sanitaria'] :   null;
    $certificado_zoosanitario = isset($_POST['certificado_zoosanitario'])  ?   $_POST['certificado_zoosanitario'] :   null;

    $razon_social_importador = isset($_POST['razon_social_importador'])  ?   $_POST['razon_social_importador'] :   null;
    $pais_origen = isset($_POST['pais_origen'])  ?   $_POST['pais_origen'] :   null;
    ...
    $muestra = new Muestra($ic_requerimiento_id, $ic_muestra_id, $fecha_muestreo, $codigo_muestras,
        ...
        ,$nombre_establecimiento,$direccion_establecimiento,$certificacion_sanitaria,$certificado_zoosanitario,$razon_social_importador,$pais_origen);
