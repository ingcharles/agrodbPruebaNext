...
$(document).ready(function() {
    ...
    $("#agregarMuestra").click(function () {
        if(rowIsValid()){
            ...
            objRow.ic_lmr_id=$("#ic_lmr_id").val();
            objRow.lmr = $("#ic_lmr_id option:selected").text();
    ...
    buildRowMuestraRapida = function (objRow, inserting) {
        var htmlRow="<tr stamped='"+objRow.stamped+"'>" +
            ...
            // "<input class='delete-row' id='delete_record' name='delete_record' type='button' onclick='triggerDeleteRecord(this)' />"+
            "</td>";
            "</tr>";
        if(inserting){
            if($("#ic_insumo_id").val()==""){
