...
<form id="editarProducto" data-rutaAplicacion="inocuidad" data-opcion="controladores/editarProducto">
    ...
    <input type="hidden" id="arr_lmr" name="arr_lmr" value=""/>
    ...
    <fieldset>
        ...
        <div data-linea="5" style="display:none">
            ...
            <tr>
                <td>
                    <select id="ic_insumo_id" name="ic_insumo_id" style="width:110px">
                        <option value="">Contaminantes ....</option>
                    </select>
                </td>
                <td>
                    <select id="ic_lmr_id" name="ic_lmr_id" style="width:110px">
