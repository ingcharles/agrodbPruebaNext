...
class Muestra implements JsonSerializable
{
    ...
    private $certificacion_sanitaria;
    private $certificado_zoosanitario;
    private $razon_social_importador;
    private $pais_origen;
     ...
     * @param $direccion_establecimiento;
     * @param $certificacion_sanitaria;
     * @param $certificado_zoosanitario;
     * @param $razon_social_importador;
     * @param $pais_origen;
     */
    public function __construct($ic_requerimiento_id, $ic_muestra_id, $fecha_muestreo, $codigo_muestras, $canton_id, $parroquia_id, $tipo_empresa, $finca_id, $utm_x, $utm_y, $registro_importador, $permiso_fitosanitario, $tecnico_id, $ic_resultado_decision_id, $activo, $estado, $provincia_id, $origen_muestra_id, $nombre_rep_legal, $pais_procedencia_id, $tipo_muestra_id, $fecha_envio_lab, $cantidad_muestras_lab, $cantidad_contra_muestra,
                 $ultimo_insumo_aplicado_id, $produccion_estimada, $fecha_ultima_aplicacion, $tecnica_muestreo, $medio_refrigeracion, $observaciones,
                 ...
                 $pais_origen)
    {
        ...
        $this->certificado_zoosanitario = $certificado_zoosanitario;

        $this->razon_social_importador = $razon_social_importador;
    ...
    /**
     * @param mixed $nombreEstablecimiento
     */
    public function setNombreEstablecimiento($nombre_establecimiento)
    {
        $this->nombre_establecimiento = $nombre_establecimiento;
    }
    /**
    ...
    /**
     * @param mixed $direccionEstablecimiento
     */
    public function setDireccionEstablecimiento($direccion_establecimiento)
    {
        $this->direccion_establecimiento = $direccion_establecimiento;
    }
     /**
     * @return mixed
     */
    public function getCertificacionSanitaria()
    {
        return $this->certificacion_sanitaria;
    }

    /**
     * @param mixed $certificacionSanitaria
     */
    public function setCertificacionSanitaria($certificacion_sanitaria)
    {
        $this->certificacion_sanitaria = $certificacion_sanitaria;
    }
     /**
     * @return mixed
     */
    public function getCertificacionZoosanitario()
    {
        return $this->certificado_zoosanitario;
    }

    /**
     * @param mixed $certificacionZoosanitario
     */
    public function setCertificacionZoosanitario($certificado_zoosanitario)
    {
        $this->certificado_zoosanitario = $certificado_zoosanitario;
    }
    /**
     * @return mixed
     */
    public function getRazonSocialImportador()
    {
        return $this->razon_social_importador;
    }

    /**
     * @param mixed $razonSocialImportador
     */
    public function setRazonSocialImportador($razon_social_importador)
    {
        $this->razon_social_importador = $razon_social_importador;
    }
        /**
     ...
     * @return mixed
     */
    public function getFechaCreacionRegistro()
    {
        return $this->fecha_creacion_registro;
    }

    /**
     * @param mixed $fecha_creacion_registro
     */
    public function setFechaCreacionRegistro($fecha_creacion_registro)
    {
