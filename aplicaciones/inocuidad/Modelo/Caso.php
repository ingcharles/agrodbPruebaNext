...
private $id_grupo;
private $usuario_id;
private $provinciaAplicacion;
private $observacionTecnico;
private $estadoRegistro;
private $fechaCreacionRegistro;
private $fechaInspeccionMes;
private $obsEliminacion;
     ...
     * @param $tprovinciaAplicacion
     * @param $observacionTecnico
     * @param $estadoRegistro
     */
    public function __construct($id, $programaId, $fuenteId, $productoId, $paisId, $provinciaId, $inspectorId, $origenMercaderiaId, $tipoRequerimientoId, $fechaSolicitud, $nombreDenunciante, $datosDenunciante, $descripcionDenuncia, $observacion, $numeroMuestras, $nombrePrograma, $nombreProducto, $tipoRequerimiento, $provinciaAplicacion, $observacionTecnico, $estadoRegistro)
    {
        $this->id = $id;
        ...
        if($provinciaAplicacion!=null)
        $this->provinciaAplicacion = $provinciaAplicacion;

        if($observacionTecnico!=null)
    ...
    /**
     * @param mixed $provinciaAplicacion
     */
    public function setProvinciaAplicacion($provinciaAplicacion)
    {
        $this->provinciaAplicacion = $provinciaAplicacion;
    }
     ...
     * @return mixed
     */
    public function getProvinciaAplicacion()
    {
        if(!isset($this->provinciaAplicacion)){
            return 0;
            }
            return $this->provinciaAplicacion;
    }
    ...
    {
        if(!isset($this->observacionTecnico)){
            return '';
        }
     ...
     * @param mixed $fechaNotificacion
     */
    public function setFechaCreacionRegistro($fechaCreacionRegistro)
    {
     ...
     * @return mixed
     */
    public function getFechaInspeccionMes()
    {
        return $this->fechaInspeccionMes;
    }

    /**
     * @param mixed $fechaInspeccionMes
     */
    public function setFechaInspeccionMes($fechaInspeccionMes)
    {
        $this->fechaInspeccionMes = $fechaInspeccionMes;
    }
