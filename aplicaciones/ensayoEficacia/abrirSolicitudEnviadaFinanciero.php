...
<fieldset>
    ...
    <div data-linea="1">
        <label>Observación: </label> <?php echo ($filaSolicitud['observacion'] ? $filaSolicitud['observacion'] : 'N/A'); ?>
    </div>

    <div data-linea="2">
        <label>Solicitud pertenece a cultivo menor: </label> <?php echo ($$filaSolicitud['cultivo_menor'] ? 'Si':'No'); ?>
    </div>
</fieldset>
