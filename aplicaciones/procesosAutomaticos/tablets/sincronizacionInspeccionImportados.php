...
//if(1){
	...
	//if(1){
		...
		while ($fila = pg_fetch_assoc($datosSincronizar)){
			...
			if($datosDDA['estado_seguimiento'] == 't' && $datosDDA['tipo_certificado']=='ANIMAL'){
				$procesoSanidadVegetal = true;
			}else if ($datosDDA['tipo_certificado']=='VEGETAL' && $seguiminetoCuarentenario == 'Si'){
				$procesoSanidadVegetal = true;
			}
			
			if($procesoSanidadVegetal){
