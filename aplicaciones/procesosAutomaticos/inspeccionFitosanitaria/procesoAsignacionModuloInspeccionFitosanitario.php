...
//if (1) {
    ...
    $resultadoMonitoreo = $cm->obtenerCronPorCodigoEstado($conexion, 'CRON_ASIG_INSP_FITO');
    ...
    //if (1) {
        ...
        echo IN_MSG . '<p><strong> INICIO REGISTRO ASIGNACION MÓDULO DE INSPECCIÓN FITOSANITARIA ' . $fecha . '</strong></p>';

        $qSolicitudProducto = $cif->obtenerIdentificadorAsignarAplicacion($conexion);
        ...
        echo IN_MSG . '<p><strong> FIN REGISTRO ASIGNACION DE MÓDULO DE INSPECCIÓN FITOSANITARIA  ' . $fecha . '</strong></p>';
