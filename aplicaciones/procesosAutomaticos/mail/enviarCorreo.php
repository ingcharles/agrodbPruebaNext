	...
	if(1){
		...
		while($correo=pg_fetch_assoc($qBuscarCorreo)){
			...
			switch ($codigoModulo) {
				...
				case 'PRG_MAIL_MASIVO'://MODULO DDA DESTINACION ADUANERA
				    $cMail->actualizarEstadoMailTablaSolicitud($conexion, $tablaModulo, 'estado_correo', $estadoMail, 'id_mail_masivo', $idSolicitudTabla);
				break;
