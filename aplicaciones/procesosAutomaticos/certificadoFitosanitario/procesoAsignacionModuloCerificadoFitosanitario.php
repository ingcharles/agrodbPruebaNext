...
//if (1) {
    ...
    $resultadoMonitoreo = $cm->obtenerCronPorCodigoEstado($conexion, 'CRON_ASIG_CERT_FITO');
    ...
    //if (1) {
        ...
        echo IN_MSG . '<p><strong> INICIO REGISTRO ASIGNACION MÓDULO DE CERTIFICACIÓN FITOSANITARIA ' . $fecha . '</strong></p>';

        $qSolicitudProducto = $ccf->obtenerIdentificadorAsignarAplicacion($conexion);
        ...
        echo IN_MSG . '<p><strong> FIN REGISTRO ASIGNACION DE MÓDULO DE CERTIFICACIÓN FITOSANITARIA  ' . $fecha . '</strong></p>';
    ...
    $arch = fopen("../../../aplicaciones/logs/cron/asignacion_modulo_certificado_fitosanitario" . date("d-m-Y") . ".txt", "a+");
