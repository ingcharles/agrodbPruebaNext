...
class PDF_BT extends FPDF
{
	function Header(){
		// Fondo
		$cts = new Constantes();
		$this->Image($cts::RUTA_SERVIDOR_OPT . '/' . $cts::RUTA_APLICACION."/aplicaciones/certificacionBrucelosisTuberculosis/img/fondo.png",0,0,210, 295);
	...
	function Body($estado, $idCertificacionBT){
		...
		$this->Image($ct::RUTA_SERVIDOR_OPT . '/' . $ct::RUTA_APLICACION.'/aplicaciones/certificacionBrucelosisTuberculosis/img/firmas/' . $nombreFirma. '.png',70, null, 70);
