    ...
    try {
        ...
        try {
            ...
            //if ($crc->validarCRC(true))
            {
				...
				$datosPorOeracionJson = $cro->obtenerDatosPorOperacionGestionOperadores($conexion, $identificador, $tipoOperacion, $area);
                $datosOperacion = (array)(json_decode($datosPorOeracionJson['fs_retorna_areas_productos_by_identificador_operador']));
