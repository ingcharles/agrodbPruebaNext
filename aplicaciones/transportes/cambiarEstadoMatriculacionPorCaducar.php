...
//if(1){
    ...
    $resultadoMonitoreo = $cm->obtenerCronPorCodigoEstado($conexion, 'CRON_MAT_PORCADUCAR');//TODO: Crear nuevo código de cron en base de datos "CRON_MAT_PORCADUCAR"
    ...
    $arch = fopen("../../../aplicaciones/logs/cron/cambio_estado_matricula_por_caducar".date("d-m-Y").".txt", "a+");
