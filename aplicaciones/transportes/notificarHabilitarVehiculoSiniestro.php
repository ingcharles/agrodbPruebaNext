...
<div id="estado"></div>
	...
	<?php
		...
		$res = $cv->abrirVehiculo($conexion, $siniestro['placa']);
...
$(document).ready(function(){
	...
	if(vehiculo == ''){
		...
		if(estadoVehiculo == 4){
			...
			$("#detalleItem").html('<div class="mensajeInicial">No puede habilitar un vehículo que no se encuentre en estado <b>Siniestro</b>.</div>');
		}
	}
