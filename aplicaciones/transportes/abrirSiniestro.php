...
<form id="formulario" data-rutaAplicacion="transportes" data-opcion="actualizarSiniestro" data-accionEnExito="ACTUALIZAR" >
	...
	<fieldset>
		...
		<div id="divArea" data-linea="40">

			<label>Provincia:</label>
				<select id="provinciaOcupante" name="provinciaOcupante" disabled="disabled" >
		...
		<div data-linea="4">
    	 ...
    	 <div data-linea="5">
			<div id="dSubOcupante">
			<label>Responsable: </label><?php echo $conductor['nombre'] .' '. $conductor['apellido']; ?>
			</div>
    	 </div>
...
var array_responsable= <?php echo json_encode($responsable); ?>;
	...
	$(document).ready(function(){
		...
		abrir($("#formulario input:hidden"),null,false);
	...
	$("#formulario").submit(function(event){
		...
		$("#formulario").attr('data-opcion', 'actualizarSiniestro');
