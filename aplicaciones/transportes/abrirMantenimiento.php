...
<body>
	...
	<form id="formulario" data-rutaAplicacion="transportes" data-opcion="actualizarMantenimiento" data-accionEnExito="ACTUALIZAR">
...
function quitarItem(fila){
	...
	$("#formulario").submit(function(event){
		...
		$("#formulario").attr('data-opcion', 'actualizarMantenimiento');
