...
<form id="formulario" data-rutaAplicacion="transportes" data-opcion="actualizarVehiculo" data-accionEnExito="ACTUALIZAR" >
...
<script type="text/javascript">
	...
	var tipos =  [  {'tid':'Jeep 4X2','moid':'Pathfinder','mid':'Nissan','tipo':'Jeep 4X2'},
		...
		$(document).ready(function(){
			...
			abrir($("#formulario #"+ $("#numPlaca").val()),null,false);
	...
	$("#formulario").submit(function(event){
		...
		$("#formulario").attr('data-opcion', 'actualizarVehiculo');
