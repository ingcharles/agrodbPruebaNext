...
<form id="formulario" data-rutaAplicacion="transportes" data-opcion="actualizarCombustible" data-accionEnExito="ACTUALIZAR">
...
var vehiculoDirEje = 0;
	...
	$("#formulario").submit(function(event){
		...
		$("#formulario").attr('data-opcion', 'actualizarCombustible');
