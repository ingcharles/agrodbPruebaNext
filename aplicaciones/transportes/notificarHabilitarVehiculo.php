...
<div id="estado"></div>
	...
	<?php
		...
		$res = $cv->abrirVehiculo($conexion, $mantenimiento['placa']);
...
$(document).ready(function(){
	...
	if(vehiculo == ''){
		...
		if(estadoVehiculo == 2){
			...
			$("#detalleItem").html('<div class="mensajeInicial">No puede habilitar un vehículo que no se encuentre en estado <b>Mantenimiento</b>.</div>');
		}
	}
});
