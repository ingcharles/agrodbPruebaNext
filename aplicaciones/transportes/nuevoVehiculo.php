...
<form id='formulario' data-rutaAplicacion='transportes' data-opcion='guardarNuevoVehiculo' data-destino="detalleItem">
...
$("#formulario").submit(function(event){
	...
	$("#formulario").attr('data-opcion', 'guardarNuevoVehiculo');
