...
<form id='formulario' data-rutaAplicacion='transportes' data-opcion='guardarNuevaMovilizacion' data-destino="detalleItem" data-accionEnExito='ACTUALIZAR'>
...
<script type="text/javascript">
	...
	function agregarOcupante(){
		...
		if($("#area").val()!=''){
    		...
    		$("#estado").html("Por favor seleccione un área y un ocupante de los listados asdfg").addClass("alerta");
    	}
	}
	...
	$("#formulario").submit(function(event){
		$("#formulario").attr('data-opcion', 'guardarNuevaMovilizacion');
	...
	$("#motivoMovilizacion").change(function(event){
		...
		$("#formulario").attr('data-opcion', 'combosMovilizacion');
	    $("#formulario").attr('data-destino', 'dSubActividades');
	    abrir($("#formulario"), event, false); //Se ejecuta ajax    	
	});
