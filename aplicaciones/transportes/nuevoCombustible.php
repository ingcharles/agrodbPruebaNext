...
<form id="formulario" data-rutaAplicacion="transportes" data-opcion="guardarNuevoCombustible" data-destino="detalleItem"  data-accionEnExito='ACTUALIZAR'>
...
$("#formulario").submit(function(event){
	...
	$("#formulario").attr('data-opcion', 'guardarNuevoCombustible');
