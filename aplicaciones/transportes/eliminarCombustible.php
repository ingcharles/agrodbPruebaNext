...
try{
    ...
    try {
        ...
        if ($identificadorUsuarioRegistro != ''){
            ...
            switch ($tipoOrden){
                case 'Combustible':{
                    $cv->darBajaCombustible($conexion, $numeroOrden, $usuarioSolicitante, $glpi, $identificadorUsuarioRegistro);
                ...
                case 'Mantenimiento':{
					...
					$cv->darBajaMantenimientoAdm($conexion, $numeroOrden, $usuarioSolicitante, $glpi, $identificadorUsuarioRegistro);                    
                    break;
                }
                
                case 'Movilizacion':{
                    $cv->actualizarEstadoVehiculo($conexion, $placa, 'Liberar');
					$cv->darBajaMovilizacionAdm($conexion, $numeroOrden, $usuarioSolicitante, $glpi, $identificadorUsuarioRegistro);
                    break;
                }
