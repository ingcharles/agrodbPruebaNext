...
<?php
	...
	echo   '<form id="notificarEliminarCombustible" data-rutaAplicacion="transportes" data-opcion="eliminarCombustible" data-AccionEnExito="ACTUALIZAR">
