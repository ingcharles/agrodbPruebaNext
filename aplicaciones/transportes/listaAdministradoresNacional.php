...
<header>
	<h1>Revisión de Administradores de Transportes Nacional</h1>
	<nav  class="width: 100%;">
	<form id="formulario" data-rutaAplicacion="transportes" data-opcion="listaAdministradoresNacionalFiltrado" data-destino="tabla">
		<table class="filtro">
			<tr>
				<th>Administrador</th>
			</tr>
...
<script>
	...
	$("#provinciaFiltro").change(function(event){
     ...
     $("#formulario").submit(function(e){
		$("#formulario").attr('data-opcion', 'listaAdministradoresNacionalFiltrado');
