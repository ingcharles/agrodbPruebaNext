...
if(1){
	...
	if(1){
		...
		*/
		...
		$qEdadCatastro = $cp->procesoActualizacionCatastroAutomaticoX ( $conexion );
		...
		while ( $filaCatastro = pg_fetch_assoc ( $qEdadCatastro ) ) {
			...
			if (($filaCatastro ['codigo'] == 'PORHON'|| $filaCatastro ['codigo'] == 'PORONA' || $filaCatastro ['codigo'] == 'POROTE'|| $filaCatastro ['codigo'] == 'PORATE' ||
					...
					&& $filaCatastro ['dias_transcurridos'] == XXXXX ) {//ES LA FECHA DE NACIMIENTO
