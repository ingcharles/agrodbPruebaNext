	...
	case '18':
		...
		break;
		 ...
		 case '19':
	       ...
	       $res = $cc -> listarReporteRecargaSaldosPorNumeroEstablecimiento($conexion, $comprobante, $fechaInicio, $fechaFin, $provincia, $establecimiento, $ruc);
	       ...
	       echo '<table>
    	    ...
    	    echo'<form id="generarReporte" action="aplicaciones/financiero/generarReporteRecargaSaldos.php" target="_blank" method="post">
		...
		case '20':
		     ...
		     $res = $cc -> listarReporteFacturasAnuladasPorNumeroEstablecimiento($conexion, $fechaInicio, $fechaFin, $provincia, $establecimiento, $ruc);
		     ...
		     echo'<form id="generarReporte" action="aplicaciones/financiero/generarReporteFacturasAnuladas.php" target="_blank" method="post">
