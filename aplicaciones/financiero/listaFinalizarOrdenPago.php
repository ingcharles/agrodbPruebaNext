<?php 
	...
	if($_POST['tipoEstado']!= 'estadoComprobante'){
	    ...
	    if($_POST['solicitudes'] == "recargaSaldo"){
	        $res = $cc -> filtrarOrdenServicio($conexion, $_POST['operador'],$_POST['factura'], $_POST['fechaInicio'], $_POST['fechaFin'], $_POST['estadoSolicitud'], null, $_POST['solicitudes']);
	    }else{    
