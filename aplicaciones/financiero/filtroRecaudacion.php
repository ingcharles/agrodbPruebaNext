...
<header>
	...
	switch ($item){
		...
		case 18:
			...
			break;
		case 19:
		    echo '<h1>Reporte de recarga de saldos</h1>';
			break;
		case 20:
		    echo '<h1>Reporte de facturas anuladas</h1>';
		    break;
	}
?>
	<nav>
...
$('document').ready(function(){
	...
	if (<?php echo $item;?> =="19"){		     
		...
		$("#establecimiento").removeAttr("disabled");
		$("#comprobante").html(''); 
		$("#comprobante").prepend('<option value="recargaSaldo" >Recarga de saldo</option>'); 
	}
	...
	if (<?php echo $item;?> =="20"){		     
		...
		$("#establecimiento").removeAttr("disabled");
		$("#comprobante").html(''); 
		$("#comprobante").prepend('<option value="factura" >Factura</option>'); 
	}
...
$("#ruc").change(function(){
	...
	if (<?php echo $item;?> =="15" ){
	    ...
	    for(var i=0;i<array_oficina.length;i++){
			...
			soficina += '<option value="002" data-ruc="1768188830001">002->Coordinación Guayas</option>';
