									...
									case '101-062':
									    ...
									    switch ($resultado[0]){
									        case SUBSANACION_REQUERIDA:
									            //$controladorVUE->actualizarEstadoVUE($formulario,SUBSANACION_REQUERIDA,SOLICITUD_DE_EVIO_VUE, $resultado[1]);
									            $controladorVUE->ingresarSolicitudesXatenderVUE($solicitudPendiente['formulario'], SUBSANACION_REQUERIDA, SOLICITUD_DE_EVIO_VUE, $solicitudPendiente['solicitud'], $resultado[1]);
									            $controladorVUE->ingresarSolicitudesVerificacionTiempoRespuesta('ImportacionMuestras', $solicitudPendiente['solicitud']);
									            $controladorVUE->finalizar($formulario,'Atendida');
									            break;
									        case ERROR_TAREA:
									            $controladorVUE->actualizarEstadoVUE($formulario,SOLICITUD_ENVIADA,ERROR_TAREA,$resultado[1]);
							...
							case '101-047':
								...
								switch ($resultado[0]){
									...
									default:
										$formulario->insertarDatosEnGUIA();
										$controladorVUE->aprobarSolicitud($formulario, 'Solicitud aprobada');
										$controladorVUE->ingresarSolicitudesVerificacionTiempoRespuesta('CLV', $solicitudPendiente['solicitud'],'registrado');
										$documentos = $controladorVUE->obtenerDocumentoAdjuntos($solicitudPendiente['solicitud'], '420');
										$formulario->insertarDocumentosAdjuntosGUIA($documentos);
										$controladorVUE->finalizar($formulario,'Atendida');
									break;
							...
							case '101-002':
								...
								switch ($resultado[0]){
									...
									case SOLICITUD_AMPLIACION:
										...
										$controladorVUE->enviarDocumentoAdjuntos($formulario, '340', RUTA_ARCHIVOS_VUE.'\importacion\ ');
									...
									default:								
										...
										switch ($resultado[0]){
											...
											default:
												...
												$controladorVUE->enviarDocumentoAdjuntos($formulario, '340', RUTA_ARCHIVOS_VUE.'\fitosanitario\ ');
												$controladorVUE->solicitudCorreccionAprobada($formulario, 'Solicitud de corrección aprobada.');
												$controladorVUE->finalizar($formulario,'Atendida');
											break;
										}			
								...
								case '101-034':
									...
									switch ($resultado[0]){
										...
										default:
											...
											//$controladorVUE->enviarDocumentoAdjuntos($formulario, '340', RUTA_ARCHIVOS_VUE.'\fitosanitarioExportacion\ ');
								...
								case '101-061':
								    ...
								    switch ($resultado[0]){
								        ...
								        default:
								            ...
								            $controladorVUE->enviarDocumentoAdjuntos($formulario, '340', RUTA_ARCHIVOS_VUE.'\TransitoInternacional\ ');
								            $controladorVUE->solicitudCorreccionAprobada($formulario, 'Solicitud de corrección aprobada.');
								            $controladorVUE->finalizar($formulario,'Atendida');
								            break;
								    }
							...
							case 'Por atender':
								...
								switch (substr($solicitudPendiente['formulario'], 0,7)){
									...
									case '101-031':
										...
										//$controladorVUE->enviarDocumentoAdjuntos($formulario, '320', RUTA_ARCHIVOS_VUE.'\fitosanitario\ ');
									...
									case '101-062':
									    ...
									    switch ($resultado[0]){
									        case SOLICITUD_APROBADA:
									            $controladorVUE->ingresarSolicitudesXatenderGUIA('101-062-REQ', '320', '21', $formulario->numeroDeSolicitud, 'Por atender', 'Solicitud aprobada.');
									            $controladorVUE->finalizar($formulario,'Atendida');
									            break;
									        case ERROR_TAREA:
									            $controladorVUE->actualizarObservacionSolicitud($conexionVUE, $resultado[1], $solicitudPendiente['id']);
						...
						if($solicitudPendiente['codigo_verificacion'] == '21'){
							switch (substr($solicitudPendiente['formulario'], 0,7)){
								case '101-002':
									...
									$controladorVUE->enviarDocumentoAdjuntos($formulario, '320', RUTA_ARCHIVOS_VUE.'\importacion\ ');
									$controladorVUE->finalizar($formulario,'Atendida');
									break;
								case '101-024':
									$controladorVUE->aprobarSolicitud($formulario, 'Solicitud aprobada');
								...
								case '101-008':
									...
									$controladorVUE->enviarDocumentoAdjuntos($formulario, '320', RUTA_ARCHIVOS_VUE.'\zoosanitario\ ');
									$controladorVUE->finalizar($formulario,'Atendida');
									break;
								case '101-031':
									$controladorVUE->aprobarSolicitud($formulario, 'Solicitud aprobada');
								...
								case '101-034':
									...
									//$controladorVUE->enviarDocumentoAdjuntos($formulario, '320', RUTA_ARCHIVOS_VUE.'\fitosanitarioExportacion\ ');
								...
								case '101-061':
								    ...
								    $controladorVUE->enviarDocumentoAdjuntos($formulario, '320', RUTA_ARCHIVOS_VUE.'\TransitoInternacional\ ');
								    $controladorVUE->finalizar($formulario,'Atendida');
								    break;
								case '101-062':
								    $controladorVUE->aprobarSolicitud($formulario, 'Solicitud aprobada');
								    $controladorVUE->envioAUCP($formulario);						    
								    $controladorVUE->crearAnexoRequisitos($formulario);
								    $controladorVUE->enviarDocumentoAdjuntos($formulario, '320', RUTA_ARCHIVOS_VUE.'\ImportacionMuestras\ ');
								    $controladorVUE->finalizar($formulario,'Atendida');
									break;
								default:
							...
							case 'Por rectificar':
								switch (substr($solicitudPendiente['formulario'], 0,7)){
									case '101-002':
										...
										$controladorVUE->enviarDocumentoAdjuntos($formulario, '330', RUTA_ARCHIVOS_VUE.'\importacion\ ');
