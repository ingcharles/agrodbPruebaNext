...
$qCantidadProductoDestinacionAduanera = $csc->abrirDatosCantidadProductoSADDA($conexion, $idDestinacionAduanera);
...
<header>
	...
	<form id='nuevoSeguimientoCuarentenario' data-rutaAplicacion='seguimientoCuarentenario' data-opcion="guardarSeguimientoCuarentenarioSA"  >
		...
		<input type="hidden" id="cantidadProductoDisponible" name="cantidadProductoDisponible" value="<?php echo $qCantidadProductoDestinacionAduanera[0]['cantidad'] ?>"/>
		<fieldset>
		...
		<fieldset>
			...
			<div data-linea="1">
				...
				<input type="text" id="cantidad" name="cantidad" maxlength="4" value="<?php echo $qCantidadProductoDestinacionAduanera[0]['cantidad'];	?>" disabled />
			</div>
			<div data-linea="2">
