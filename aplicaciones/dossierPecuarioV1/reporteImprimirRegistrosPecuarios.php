...
$logoIzquierda= $constg::RUTA_SERVIDOR_OPT.'/'.$constg::RUTA_APLICACION.'/aplicaciones/ensayoEficacia/img/logo1.png';
$logoDerecha= $constg::RUTA_SERVIDOR_OPT.'/'.$constg::RUTA_APLICACION.'/aplicaciones/ensayoEficacia/img/logo2.png';
