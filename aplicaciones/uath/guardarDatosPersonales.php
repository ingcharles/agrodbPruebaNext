...
try{
	...
	$identidadgenero=$_POST['identidadgenero'];
	...
	try {
		...
		$fotoFondo = $constgi::RUTA_SERVIDOR_OPT . '/' . $constgi::RUTA_APLICACION . '/aplicaciones/uath/fotos/credencial/frente.png';
		$fotoQR = $constgi::RUTA_SERVIDOR_OPT . '/' . $constgi::RUTA_APLICACION . '/' . $perfilPublico['ruta_qr_perfil_publico'];

		$parameters['parametrosReporte'] = array(
		    'identificador' => $identificador,
		    'fotoFondo' => $fotoFondo,
		    'fotoPersona' => $rutaFotografia,
		    'fotoQR' => $fotoQR
		);
		
		$jru->generarReporteJasper($ReporteJasper, $parameters, $conexion, $salidaReporte, 'perfilPublicoCredencial');
