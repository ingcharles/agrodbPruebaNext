		...
		<tr>
			...
			<td-->
				...
				<div data-linea="8">
					...
					<div data-linea="9">
						<label>Identidad genero</label> <select name="identidadgenero" id="identidadgenero"
							disabled="disabled">
							<option value="" >Seleccione....</option>
								<option value="Femenino">Femenino</option>
								<option value="Masculino">Masculino</option>
...
<script type="text/javascript">
	...
	$("#datosPersonales").submit(function(event){
		...
		if($("#identidadgenero").val()==""){
			error = true;
			$("#identidadgenero").addClass("alertaCombo");
		}
		if($("#lateralidad").val()==""){
			error = true;
	...
	$(document).ready(function(){
		...
		cargarValorDefecto("identidadgenero","<?php echo $empleado['identidad_genero'];?>");
