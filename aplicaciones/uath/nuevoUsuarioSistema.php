...
<script>
	...
	$("#tipo").change(function(e){
		if ($("#tipo").val() == 'Externo'){
			...
			$("#mail_institucional").attr('readonly',true);
		} else{
			$("#mail_institucional").removeAttr('readonly');
		}
	});
    ...
    $("#nuevoUsuario").submit(function(e) {
		...
		// if( $("#mail_institucional").val() != '' && !esCampoValido("#mail_institucional")){
		// 		$("#mail_institucional").addClass("alertaCombo");	
		// 		mostrarMensaje("Mail institucional no válido.","FALLO");
		// 		return;
		// 	}

		// if( $("#mail_personal").val() != '' && !esCampoValido("#mail_personal")){
		// 	$("#mail_personal").addClass("alertaCombo");	
		// 	mostrarMensaje("Mail personal no válido.","FALLO");
		// 	return;
		// }
