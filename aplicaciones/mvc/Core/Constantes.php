...
//const SESSION_CERRRADA = "No existe una sesión de usuario activa";
     ...
     * Casos especiales
     */
    const SER_MARBETES = 34;    //Servicio de primer nivel Marbetes
    const SER_FA_EXCEL = "499,500";     //Servicios de Fiabre Aftosa que deben subirse el excel de muestras
    const LAB_INGREDIENTES_ACTIVOS = "167,107";     //Laboratorios que tienen ingredientes activos
    const SER_PREDETERMINADOS = "569,803"; //Servicios que se agregan por defecto, ejm: DETERMINACION DE DENSIDAD
	...
	/**
     * modulo de firma Electronica
     */
    const ERROR_FIRMA = 'No se pudo obtener datos del archivo, revise la clave o el archivo!';
    const ACTUALIZAR_FIRMA = 'Firma actualizada con éxito!';
    const ERROR_CADUCIDAD_FIRMA = 'La firma se encuentra caducada!';
	
	/**
     * modulo de inspeccion fitosanitaria
     */
    const ERROR_INSPECCION_USADA = 'La inspección seleccionada ya está siendo utilizada en un certificado fitosanitario.';
	...
	// const RUTA_DOMINIO =  'http://181.112.155.163'; //'http://181.112.155.173'; // 1 pruebas http://181.112.155.173 // 2 produccion
...
/*
    ...
    */
	...
	public static function clienteServiciosWeb()
    {
        return new class() extends Constantes {
            public $CLIENTE_EXTERNO = "OUT_CLIENT";
            public $CLIENTE_INTERNO = "IN_CLIENT";
        };
    }
	
	/*
     * Constante de distribucion inicial
     * */
    const NUMERO_CEROS = 7;
}
