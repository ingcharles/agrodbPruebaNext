...
class AplicacionesModelo extends ModeloBase 
{
		...
		* 
		*/
		protected $fechaCargaAplicacion;
		/**
		* @var String
		* Campo requerido
		* Campo visible en el formulario
...
*/
	...
	*Secuencia
*/
		 private $secuencial = 'g_programas"."Aplicaciones_id_aplicacion_seq'; 
	...
	*/
	...
	/**
	* Set fechaCargaAplicacion
	*
	*
	*
	* @parámetro Date $fechaCargaAplicacion
	* @return FechaCargaAplicacion
	*/
	public function setFechaCargaAplicacion($fechaCargaAplicacion)
	{
	  $this->fechaCargaAplicacion = (String) $fechaCargaAplicacion;
	    return $this;
	}

	/**
	* Get fechaCargaAplicacion
	*
	* @return null|Date
	*/
	public function getFechaCargaAplicacion()
	{
		return $this->fechaCargaAplicacion;
	}
