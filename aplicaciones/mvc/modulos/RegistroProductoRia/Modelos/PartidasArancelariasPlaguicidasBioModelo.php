<?php
 /**
 * Modelo PartidasArancelariasPlaguicidasBioModelo
 *
 * Este archivo se complementa con el archivo   PartidasArancelariasPlaguicidasBioLogicaNegocio.
 *
 * @author  AGROCALIDAD
 * @date    2022-12-22
 * @uses    PartidasArancelariasPlaguicidasBioModelo
...
class PartidasArancelariasPlaguicidasBioModelo extends ModeloBase 
{
	...
	* 
	...
	/**
	* Nombre de la tabla: partidas_arancelarias_plaguicidas_bio
	* 
	 */
	Private $tabla="partidas_arancelarias_plaguicidas_bio";
...
*/
	...
	*Secuencia
*/
		 private $secuencial = 'g_registro_productos"."partidas_arancelarias_plaguicidas_bi_id_partida_arancelaria_seq'; 
	...
	*/
	...
	{
		throw new \Exception('Clase Modelo: PartidasArancelariasPlaguicidasBioModelo. Propiedad especificada invalida: set'.$name);
	}
	$this->$method($value);
	}
	...
	*/
	...
	if (!method_exists($this, $method))
	{
	  throw new \Exception('Clase Modelo: PartidasArancelariasPlaguicidasBioModelo. Propiedad especificada invalida: get'.$name);
	}
	return $this->$method();
	}
