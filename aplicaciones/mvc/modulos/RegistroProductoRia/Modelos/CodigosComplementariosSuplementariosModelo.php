<?php
/**
 * Modelo CodigosComplementariosSuplementariosModelo
 *
 * Este archivo se complementa con el archivo   CodigosComplementariosSuplementariosLogicaNegocio.
 *
 * @author  AGROCALIDAD
 * @date    2022-12-20
 * @uses    CodigosComplementariosSuplementariosModelo
...
class CodigosComplementariosSuplementariosModelo extends ModeloBase
{
     ...
     * Campo requerido
     * Campo visible en el formulario
     * Codigo complementario del producto
     */
     ...
     * Campo requerido
     * Campo visible en el formulario
     * Codigo suplementario del producto
     */
    ...
    /**
     * Nombre de la tabla: codigos_complementarios_suplementarios
     *
     */
    private $tabla = "codigos_complementarios_suplementarios";
     ...
     *Secuencia
     */
    private $secuencial = 'g_registro_productos"."codigos_complementarios_suple_id_codigo_complementario_supl_seq';
    ...
    public function __set($name, $value)
    {
        ...
        if (!method_exists($this, $method)) {
            throw new \Exception('Clase Modelo: CodigosComplementariosSuplementariosModelo. Propiedad especificada invalida: set' . $name);
        }
        $this->$method($value);
    }
    ...
    public function __get($name)
    {
        $method = 'get' . $name;
        if (!method_exists($this, $method)) {
            throw new \Exception('Clase Modelo: CodigosComplementariosSuplementariosModelo. Propiedad especificada invalida: get' . $name);
        }
        return $this->$method();
    }
