...
<script type="text/javascript">
    ...
    var tipoSolicitud = "registroProductoRia";
    ...
    $("#formularioAsignarRevisor").submit(function (event) {
        ...
        if (!error) {
            ...
            $.post("<?php echo URL ?>RegistroProductoRia/RevisionSolicitudesRegistroProductos/guardarAsignacionRevisor",
                {
    ...
    function fn_eliminarDetalleRevisorAsignado(idAsignacionCoordinador, idSolicitudRegistroProducto ) {
        $("#estado").html("").removeClass('alerta');
        $.post("<?php echo URL ?>RegistroProductoRia/RevisionSolicitudesRegistroProductos/eliminarAsignacionRevisor",
            {
                idAsignacionCoordinador: idAsignacionCoordinador,
                idSolicitudRegistroProducto : idSolicitudRegistroProducto
            },
            function (data) {
