...
<script type="text/javascript">
    ...
    var tipoSolicitud = "ensayoEficacia";
    ...
    $("#formularioAsignarRevisor").submit(function (event) {
        ...
        if (!error) {
            ...
            $.post("<?php echo URL ?>EnsayoEficacia/RevisionSolicitudes/guardarAsignacionRevisor",
                {
    ...
    function fn_eliminarDetalleRevisorAsignado(idAsignacionCoordinador, idSolicitud ) {
        $("#estado").html("").removeClass('alerta');
        $.post("<?php echo URL ?>EnsayoEficacia/RevisionSolicitudes/eliminarAsignacionRevisor",
            {
