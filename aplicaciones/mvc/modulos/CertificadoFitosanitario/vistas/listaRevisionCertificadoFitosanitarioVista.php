<header><nav><?php echo $this->panelBusquedaCertificado;?></nav>
	...
	function fn_filtrar() {
		...
		if (!error) {
			$("#paginacion").html("<div id='cargando'>Cargando...</div>");
			  $.post("<?php echo URL ?>CertificadoFitosanitario/RevisionCertificadoFitosanitario/listarCertificadosFitosanitariosFiltrados",
		    	{
