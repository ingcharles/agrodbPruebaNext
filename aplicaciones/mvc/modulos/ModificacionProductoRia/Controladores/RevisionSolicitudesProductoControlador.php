...
class RevisionSolicitudesProductoControlador extends BaseControlador
{
    ...
    public function asignarSolicitudes()
    {
        ...
        $arrayParametros = array(
            ...
            'estado_solicitud_producto' => "'inspeccion', 'asignadoInspeccion'"
        );

        $solicitudesModificacion = $this->lNegocioSolicitudesProductos->buscarSolicitudesProductoXFiltro($arrayParametros);
    ...
    public function asignarTecnico()
    {
        ...
        foreach ($idSolicitudProducto as $solicitud) {
            ...
            $cultivoMenor = $datosSolicitud->getCultivoMenor();
            $enlaceDocumento = $datosSolicitud->getEnlaceDocumento();

            $arrayDatosSolicitud = array('numeroSolicitud' => $numeroSolicitud, 'rutaEtiquetaProducto' => $rutaEtiquetaProducto, 'observacion' => $observacion);
            ...
            $this->datosGenerales .= $this->cargarPanelDatosGenerales($cultivoMenor, $observacion, $rutaEtiquetaProducto, $enlaceDocumento);
    ...
    public function revisarSolicitudTecnico()
    {
        ...
        $rutaEtiquetaProducto = $datosSolicitud->getRutaEtiquetaProducto();
        $observacion = $datosSolicitud->getObservacion();
        $cultivoMenor = $datosSolicitud->getCultivoMenor() === 'Si' ? true : false;
        ...
        foreach ($tiposModificacion as $item) {
            ...
            $modificaciones[] = array(
                ...
                'requiere_etiqueta' => $item->requiere_etiqueta,
    ...
    public function resultadoRevisionTecnica($parametros, $tiempoAtencion, $idDetalleSolicitudProducto, $estadoSolicitudProducto)
    {
        ...
        $resultadoRevision = '<fieldset  id="fDatosGenerales">
        ...
        <form id="resuladoRevisionTecnica" data-rutaAplicacion="' . URL_MVC_FOLDER . 'ModificacionProductoRia" data-opcion="RevisionSolicitudesProducto/guardarProcesoRevisionTecnica" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR" method="post">
            <input type="hidden" id="id_solicitud_producto" name="id_solicitud_producto" value="' . $idSolicitudProducto . '" />
            <fieldset  id="fResuladoRevisionTecnica">
                ...
                <div data-linea="5">
                    ...
                    <input type="file" class="archivo validacion" id="vInforme" accept="application/pdf" />
                ...
                <label>Verificación de firmas: </label>
                <div data-linea="6">
                    <input type="hidden" class="rutaArchivo" id="verificacionFirma" name="verificacionFirma" value="0"/>
                    <input type="file" class="archivo" id="vFirma" accept="application/pdf" />
                    <div class="estadoCarga">En espera de archivo... (Tamaño máximo ' . ini_get('upload_max_filesize') . 'B)</div>
                    <button type="button" class="subirArchivo adjunto" data-rutaCarga="' . MODI_PROD_RIA_URL . $this->rutaFecha . '">Subir archivo</button>
                </div>  
            </fieldset>
    ...
    public function guardarProcesoRevisionTecnica()
    {
        ...
        $rutaVerificacionFirma = $_POST['verificacionFirma'];
