	    ...
	    $consulta = "SELECT
                        ...
                        FROM 
                        	...
                        	FROM 
                        		...
                        		INNER JOIN g_modificacion_productos.detalle_solicitudes_productos dsp ON dsp.id_detalle_solicitud_producto = app.id_detalle_solicitud_producto and dsp.id_detalle_solicitud_producto = '" . $idDetalleSolicitudProducto . "'
