...
class SolicitudesProductosModelo extends ModeloBase
{
     ...
     * Campo requerido
     * Campo visible en el formulario
     * Campo que almacena la fecha de envio de subsanacion de la solicitud por parte del usuario
     */
    protected $fechaEnvioSubsanacion;
    /**
     * @var String
     * Campo requerido
     * Campo visible en el formulario
     ...
     * Campo requerido
     * Campo visible en el formulario
     * Ruta verificacion firma
     */
    protected $rutaVerificacionFirma;
    /**
     * @var String
     * Campo requerido
     * Campo visible en el formulario
     * Campo que indica si el producto pertenece a cultvo menor
     */
	...
	/**
		...
		* Campo requerido
		* Campo visible en el formulario
		* Campo que almacela un enlace de descarga de documentos
		*/
	protected $enlaceDocumento;
    ...
    /**
     * Set fechaEnvioSubsanacion
     *
     *Campo que almacena la fecha de envio de subsanacion de la solicitud por parte del usuario
     *
     * @parámetro Date $fechaEnvioSubsanacion
     * @return FechaEnvioSubsanacion
     */
    public function setFechaEnvioSubsanacion($fechaEnvioSubsanacion)
    {
        $this->fechaEnvioSubsanacion = (string)$fechaEnvioSubsanacion;
        return $this;
    }

    /**
     * Get fechaEnvioSubsanacion
     *
     * @return null|Date
     */
    public function getFechaEnvioSubsanacion()
    {
        return $this->fechaEnvioSubsanacion;
    }
    ...
    /**
     * Set rutaVerificacionFirma
     *
     *Ruta a documento con las observaciones del proceso de revision tecnica
     *
     * @parámetro String $rutaVerificacionFirma
     * @return RutaVerificacionFirma
     */
    public function setRutaVerificacionFirma($rutaVerificacionFirma)
    {
        $this->rutaVerificacionFirma = (string)$rutaVerificacionFirma;
        return $this;
    }

    /**
     * Get rutaVerificacionFirma
     *
     * @return null|String
     */
    public function getRutaVerificacionFirma()
    {
        return $this->rutaVerificacionFirma;
    }
	...
	*Campo que almacela un enlace de descarga de documentos
	*
	* @parámetro String $enlaceDocumento
	* @return EnlaceDocumento
	*/
	public function setEnlaceDocumento($enlaceDocumento)
	{
	  $this->enlaceDocumento = (String) $enlaceDocumento;
	    return $this;
	}
