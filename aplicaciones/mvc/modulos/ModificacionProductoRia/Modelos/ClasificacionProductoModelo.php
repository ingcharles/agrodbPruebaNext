<?php
 /**
 * Modelo ClasificacionProductoModelo
 *
 * Este archivo se complementa con el archivo   ClasificacionProductoLogicaNegocio.
 *
 * @author  AGROCALIDAD
 * @date    2022-09-10
 * @uses    ClasificacionProductoModelo
...
class ClasificacionProductoModelo extends ModeloBase 
{
		...
		*/
		protected $idClasificacionProducto;
		/**
		* @var Integer
		* Campo requerido
		* Campo visible en el formulario
		...
		* Campo requerido
		* Campo visible en el formulario
		* Campo que almacena el nombre de la clasificacion del producto
		*/
	...
	* 
	...
	/**
	* Nombre de la tabla: clasificacion_producto
	* 
	 */
	Private $tabla="clasificacion_producto";

	/**
	*Clave primaria
*/
		 private $clavePrimaria = "id_clasificacion_producto";
	...
	*Secuencia
*/
		 private $secuencial = 'g_modificacion_productos"."clasificacion_producto_id_clasificacion_producto_seq'; 
	...
	*/
	...
	{
		throw new \Exception('Clase Modelo: ClasificacionProductoModelo. Propiedad especificada invalida: set'.$name);
	}
	$this->$method($value);
	}
	...
	*/
	...
	if (!method_exists($this, $method))
	{
	  throw new \Exception('Clase Modelo: ClasificacionProductoModelo. Propiedad especificada invalida: get'.$name);
	}
	return $this->$method();
	}
	...
	*/
	...
	/**
	* Set idClasificacionProducto
	*
	*Identificador unico de la tabla
	*
	* @parámetro Integer $idClasificacionProducto
	* @return IdClasificacionProducto
	*/
	public function setIdClasificacionProducto($idClasificacionProducto)
	{
	  $this->idClasificacionProducto = (Integer) $idClasificacionProducto;
	    return $this;
	}

	/**
	* Get idClasificacionProducto
	*
	* @return null|Integer
	*/
	public function getIdClasificacionProducto()
	{
		return $this->idClasificacionProducto;
	}
