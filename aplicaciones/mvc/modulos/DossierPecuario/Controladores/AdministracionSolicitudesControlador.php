...
class AdministracionSolicitudesControlador extends BaseControlador
{
    ...
    public function comboEstadosDossierPecuario($opcion = null)
    {
        ...
        if ($opcion == "Recibido") {
            ...
            $combo .= '<option value="pago">Asignación de Tasa</option>';
            $combo .= '<option value="verificacion">En espera de pago</option>';
            $combo .= '<option value="Pagado">Pagado</option>';
            ...
            $combo .= '<option value="Subsanacion">Subsanacion</option>';
            $combo .= '<option value="Modificado">Modificado</option>';
            $combo .= '<option value="pago" selected="selected">Asignación de Tasa</option>';
            $combo .= '<option value="verificacion">En espera de pago</option>';
            $combo .= '<option value="Pagado">Pagado</option>';
        } else if ($opcion == "verificacion") {
            $combo .= '<option value="Recibido">Recibido</option>';
            $combo .= '<option value="EnTramite">En trámite</option>';
            $combo .= '<option value="Aprobado">Aprobado</option>';
            $combo .= '<option value="Rechazado">Rechazado</option>';
            ...
            $combo .= '<option value="Modificado">Modificado</option>';
            $combo .= '<option value="pago">Asignación de Tasa</option>';
            $combo .= '<option value="verificacion" selected="selected">En espera de pago</option>';
            $combo .= '<option value="Pagado">Pagado</option>';
        } else if ($opcion == "Pagado") {
            $combo .= '<option value="Recibido">Recibido</option>';
            $combo .= '<option value="EnTramite">En trámite</option>';
            $combo .= '<option value="Aprobado">Aprobado</option>';
            $combo .= '<option value="Rechazado">Rechazado</option>';
            ...
            $combo .= '<option value="pago">Asignación de Tasa</option>';
            $combo .= '<option value="verificacion">En espera de pago</option>';
            $combo .= '<option value="Pagado" selected="selected">Pagado</option>';
        } else {
            $combo .= '<option value="Recibido">Recibido</option>';
            $combo .= '<option value="EnTramite">En trámite</option>';
            $combo .= '<option value="Aprobado">Aprobado</option>';
