...
class SecuenciaRevisionLogicaNegocio implements IModelo
{
    ...
    public function guardar(Array $datos)
    {
        switch ($datos['estado_revision']) {
            ...
            case 'Rechazado':
             ...
             case 'Aprobado':
                $datos['accion'] = "Se ha aprobado la solicitud";
                break;
     ...
     * Función para guardar el histórico de cambios de estado / reporte
     */
    public function guardarHistoricoAprobacionAutomatica($idSolicitud, $estadoSolicitud, $observacion)
    {
        $arrayParametros = array(   'id_solicitud' =>  $idSolicitud,
                                    'identificador_ejecutor' =>  'GUIA',
                                    'nombre_ejecutor' =>  'GUIA',
                                    'perfil' =>  'CRON',
                                    'id_provincia' => 'NA',
                                    'provincia' => 'NA',
                                    'estado_revision' =>  $estadoSolicitud,
