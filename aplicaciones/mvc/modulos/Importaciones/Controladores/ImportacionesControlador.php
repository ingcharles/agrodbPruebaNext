	...
	public function listaProductosImportacion($productosImportacion, $idArea){
		...
		foreach ($productosImportacion as $producto){
			...
			if ($idArea == 'IAV'){
			    ...
			    //Buscar listado de partidas para plaguicidas
			    $datosPartida = $this->lNegocioPartidasArancelarias->comboPartidaProductoPlaguicidaImportacion($producto['id_producto']);
			    $datosCodigoPartida = $this->lNegocioPartidasArancelarias->comboCodigoPartidaProductoPlaguicidaImportacion($producto['id_producto']);
			    $datosCodigosCompSupl = $this->lNegocioCodigosCompSupl->comboCodigoCompSuplPartidaProductoPlaguicidaImportacion($producto['id_producto']);
			    $datosPresentaciones = $this->lNegocioPresentacionesPlaguicidas->comboPresentacionesCodigoCompSuplPartidaProductoPlaguicidaImportacion($producto['id_producto']);
			    
			    $this->productos .= '<fieldset>
									<legend>Producto de importación IAP ' . ++ $contador . '</legend>
									...
									<div data-linea="2">
										<label>Código producto: </label>
                                            <select name="codigo_producto_vue[]" class="validacion">
											<option value="">Seleccionar....</option>
											' . $datosCodigoPartida . '
										</select>
									</div>
