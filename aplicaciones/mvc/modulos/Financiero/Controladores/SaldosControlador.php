...
class SaldosControlador extends BaseControlador
{
        ...
        $this->comboIdentificador = '<table class="filtro" style="width: 400px;">
                        				<tbody>
                                            ...
                                            <tr >
                                                <th>Fecha inicio:</th>
                                                <td>
                                                    <input id="fechaInicio" type="text" name="fechaInicio" style="width: 100%" required="true" class="camposRequeridos" onChange="calcularFechas(this),10" autocomplete="off">
                                                </td>
                                            </tr>
                                            <tr >
                                                <th>Fecha fin:</th>
                                                <td>
                                                    <input id="fechaFin" type="text" name="fechaFin" style="width: 100%" required="true" class="camposRequeridos" autocomplete="off">
                                                </td>
                                            </tr>
                        					<tr>
    ...
    public function nuevoRecargaSaldos()
    {
        ...
        if (!$this->usuarioInterno) {
            ...
            $this->accion = "El usuario debe ser externo para realizar el proceso!";
            require APP . 'Financiero/vistas/errorUsuarioInternoVista.php';
        }
    ...
    public function buscarOrdenPagoSaldoDisponible()
    {
        ...
        $ordenesRecargaSaldo = $this->lNegocioOrdenPago->buscarLista("identificador_operador = '" . $arrayParametros['identificador_operador'] . "' 
                                                            ...
                                                            and tipo_solicitud='" . $arrayParametros['tipo_solicitud'] . "' ORDER BY fecha_orden_pago desc");
    ...
    public function buscarSaldoDiario()
    {
        ...
        if (!$totalSaldo) {
            ...
            $mensaje = "El día de hoy ha ingresado " . $datosOrdenes->current()->total_saldo . " USD, la cantidad a ingresar excede el cupo permitido de 5000 USD diarios.";
            } else{
                $mensaje = "La cantidad a ingresar excede el cupo permitido de 5000 USD diarios.";
            }
        }
    ...
    public function generarCertificadoRecargaSaldo($idPago, $identificadorOperador)
    {
        ...
        $operador = $this->lNegocioOperadores->buscar($_SESSION['usuario']);
        $provincia = $operador->getProvincia();

        $this->lNegocioOrdenPago->generarOrdenPago($idPago, $rutaFecha, $nombreArchivo, $provincia);
    ...
    public function cargarDatosRecargaSaldo($datos)
    {
        ...
        $this->cabeceraRecargaSaldo = '<fieldset>
             ...
             if(isset($datos->current()->factura)){
                $this->cabeceraRecargaSaldo .= ' <div data-linea = "8">
                                                    <label>Comprobante de Saldo: </label> <a href=' . $datos->current()->factura . ' target="_blank" download>Descargar comprobante de saldo</a>
                                                </div>';
             }
