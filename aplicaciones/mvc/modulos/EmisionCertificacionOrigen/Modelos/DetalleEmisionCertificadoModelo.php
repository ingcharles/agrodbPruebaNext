...
class DetalleEmisionCertificadoModelo extends ModeloBase 
{
		...
		* 
		*/
		protected $observacionAnulacion;
		/**
		* @var String
		* Campo requerido
		* Campo visible en el formulario
		* 
		*/
		protected $fechaCreacionProduccion;
...
*/
	...
	*Secuencia
*/
		 private $secuencial = 'g_emision_certificacion_origen"."DetalleEmisionCertificado_id_detalle_emision_certificado_seq'; 
	...
	*/
	...
	/**
	* Set tipoMovilizacionCanal
	*
	*Tipo movilización canal
	*
	* @parámetro String $tipoMovilizacionCanal
	* @return TipoMovilizacionCanal
	*/
	...
	*
	*
	* @parámetro String $estadoDetalle
	* @return EstadoDetalle
	*/
	public function setEstadoDetalle($estadoDetalle)
	{
	  $this->estadoDetalle = (String) $estadoDetalle;
	    return $this;
	}
	...
	*
	*
	* @parámetro String $observacionAnulacion
	* @return ObservacionAnulacion
	*/
	public function setObservacionAnulacion($observacionAnulacion)
	{
	  $this->observacionAnulacion = (String) $observacionAnulacion;
	    return $this;
	}
	...
	*/
	...
	/**
	* Set fechaCreacionProduccion
	*
	*
	*
	* @parámetro String $fechaHoraFaenamiento
	* @return FechaCreacionProduccion
	*/
	public function setFechaCreacionProduccion($fechaCreacionProduccion)
	{
	  $this->fechaCreacionProduccion = (String) $fechaCreacionProduccion;
	    return $this;
	}

	/**
	* Get fechaCreacionProduccion
	*
	* @return null|String
	*/
	public function getFechaCreacionProduccion()
	{
		return $this->fechaCreacionProduccion;
	}
