 ...
 *
 * Este archivo se complementa con el archivo   EmpresaLogicaNegocio.
 *
 * @author  AGROCALIDAD
 * @date    2022-08-31
 * @uses    EmpresaModelo
...
class EmpresaModelo extends ModeloBase 
{
	...
	*Clave primaria
*/
		 private $clavePrimaria = "id_empresa";
	...
	*Secuencia
*/
		 private $secuencial = 'g_emision_certificacion_origen"."empresa_id_empresa_seq'; 
	...
	*/
	...
	{
		throw new \Exception('Clase Modelo: EmpresaModelo. Propiedad especificada invalida: set'.$name);
	}
	$this->$method($value);
	}
	...
	*/
	...
	if (!method_exists($this, $method))
	{
	  throw new \Exception('Clase Modelo: EmpresaModelo. Propiedad especificada invalida: get'.$name);
	}
	return $this->$method();
	}
	...
	*/
	...
	/**
	* Set identificadorEmpresa
	*
	*
	*
	* @parámetro String $identificadorEmpresa
	* @return IdentificadorEmpresa
	*/
	public function setIdentificadorEmpresa($identificadorEmpresa)
	{
	  $this->identificadorEmpresa = (String) $identificadorEmpresa;
	    return $this;
	}

	/**
	* Get identificadorEmpresa
	*
	* @return null|String
	*/
	...
	*
	*
	* @parámetro String $nombreEmpresa
