...
<?php
	...
	mb_internal_encoding('UTF-8'); // Configura la codificación interna a UTF-8
	$this->itemsFiltrados = utf8_encode_recursive($this->itemsFiltrados); // Aplica la codificación UTF-8 recursivamente a todos los elementos del arreglo
?>
