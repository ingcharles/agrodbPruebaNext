...
class CentrosFaenamientoControlador extends BaseControlador
{
	...
	public function exportarCentrosFaenamientoExcel() {
        ...
        $qDatos=$this->lNegocioCentrosFaenamiento->obtenerDatosMovilizacionEmisionOrigen($arrayParametros);
        $this->lNegocioCentrosFaenamiento->exportarArchivoExcelEmisionCertificacion($qDatos);
    }
