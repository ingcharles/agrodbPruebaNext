...
class TipoProductosLogicaNegocio implements IModelo
{
	...
	/**
     * Ejecuta una consulta(SQL) personalizada .
     * Buscar información de Tipos de Productos por área temática por codificacion tipo producto.
     *
     * @return array|ResultSet
     */
    public function buscarTipoProductoPorAreaPorCodificacion($area, $codificacionTipoProducto)
    {
        $consulta = "SELECT
                        	tp.*
                        FROM
                        ...
                        WHERE
                            tp.id_area = '" . $area . "'
                            and tp.codificacion_tipo_producto = '" . $codificacionTipoProducto . "'
                            and tp.estado = 1;";
