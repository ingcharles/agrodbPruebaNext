...
class SubtipoProductosLogicaNegocio implements IModelo{
	...
	/**
	 * Ejecuta una consulta(SQL) que permite obtener los subtipos por idSubtipoProducto.
	 *
	 * @return array|ResultSet
	 */
	public function buscarSubtipoProductoPorIdSubtipoProducto($idProducto){
	    ...
	    $consulta = "SELECT
                        ...
                        FROM
                        	g_catalogos.subtipo_productos stp
                        INNER JOIN (SELECT
                        					tp.id_tipo_producto, p.id_producto, stp.estado
                        			FROM
                        			...
                        			) as ttp ON ttp.id_tipo_producto = stp.id_tipo_producto
                        WHERE
