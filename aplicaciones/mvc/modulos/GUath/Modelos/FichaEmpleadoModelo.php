...
class FichaEmpleadoModelo extends ModeloBase 
{
		...
		*/
		...
		protected $tipoDiscapacidad;
		
		protected $porcentajeDiscapacidad;
...
*/
	 ...
	 if(empty($tipoEmpleado)) 
 {
	...
	*/
	...
	{
	  	$this->porcentajeDiscapacidad = (int) $porcentajeDiscapacidad;
	    return $this;
	}
	...
	{
	  	$this->tipoDiscapacidad = (String) $tipoDiscapacidad;
	    return $this;
	}
