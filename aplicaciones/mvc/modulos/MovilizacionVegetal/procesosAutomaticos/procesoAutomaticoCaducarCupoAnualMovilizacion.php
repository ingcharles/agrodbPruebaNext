...
//define('ROOT', 'C:/xampp/htdocs/agrodbNext/aplicaciones/'); //***definir ruta de la aplicacion***
...
$app = new Router('MovilizacionVegetal','AsignacionCupo','paCaducarCupoAnualMovilizacion');