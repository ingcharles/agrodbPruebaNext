...
class HabitosModelo extends ModeloBase{
	...
	protected $sustancias;
	protected $habitoToxico;
	protected $mesesHabitoAbstinencia;
	protected $exconsumidor;
	 ...
	 * cantidad de habito
	 *
	 * @parámetro String $cantidadHabito
	 * @return cantidadHabito
	 */
	public function setCantidadHabito($cantidadHabito){
		$this->cantidadHabito = (string) $cantidadHabito;
		return $this;
	}
	 ...
	 * @return null|String
	 */
	public function getCantidadHabito(){
		return $this->cantidadHabito;
	}
	 ...
	 * Años de habito
	 *
	 * @parámetro Integer $mesesHabito
	 * @return mesesHabito
	 */
	public function setMesesHabito($mesesHabito){
		$this->mesesHabito = (integer) $mesesHabito;
		return $this;
	}
	 ...
	 * @return null|Integer
	 */
	public function getMesesHabito(){
		return $this->mesesHabito;
	}
	...
	public function setSustancias($sustancias){
		$this->sustancias = (string) $sustancias;
		return $this;
	}

	public function getSustancias(){
		return $this->sustancias;
	}

	public function setHabitoToxico($habitoToxico){
		$this->habitoToxico = (string) $habitoToxico;
		return $this;
	}
	...
	public function setMesesHabitoAbstinencia($mesesHabitoAbstinencia){
		$this->mesesHabitoAbstinencia = (int) $mesesHabitoAbstinencia;
		return $this;
	}

	public function getMesesHabitoAbstinencia(){
		return $this->mesesHabitoAbstinencia;
	}

	public function setExconsumidor($exconsumidor){
		$this->exconsumidor = (string) $exconsumidor;
		return $this;
	}

	public function getExconsumidor(){
