...
class AntecedentesSaludFamiliarModelo extends ModeloBase{
	...
	protected $origenParentesco;
	protected $tipoEnfermedadFamiliar;
	protected $especifiqueFamiliar;
	/**
	 *
	...
	public function setOrigenParentesco($origenParentesco){
		$this->origenParentesco = (string) $origenParentesco;
		return $this;
	}
	public function getOrigenParentesco(){
		return $this->origenParentesco;
	}

	public function setTipoEnfermedadFamiliar($tipoEnfermedadFamiliar){
		$this->tipoEnfermedadFamiliar = (string) $tipoEnfermedadFamiliar;
		return $this;
	}
	public function getTipoEnfermedadFamiliar(){
		return $this->tipoEnfermedadFamiliar;
	}

	public function setEspecifiqueFamiliar($especifiqueFamiliar){
		$this->especifiqueFamiliar = (string) $especifiqueFamiliar;
		return $this;
	}
	public function getEspecifiqueFamiliar(){
		return $this->especifiqueFamiliar;
	}
