...
class HistoriaClinicaModelo extends ModeloBase{
	...
	protected $tipoRestriccionObservacion;
	...
	public function setTipoRestriccionObservacion($tipoRestriccionObservacion){
		$this->tipoRestriccionObservacion = (string) $tipoRestriccionObservacion;
		return $this;
	}

	public function getTipoRestriccionObservacion(){
		return $this->tipoRestriccionObservacion;
	}
