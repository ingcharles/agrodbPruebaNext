...
class AccidentesLaboralesModelo extends ModeloBase{
	...
	protected $institutoSeguridad;
	protected $fechaTrabajoAccidente;
	protected $puestoTrabajoAccidente;
	protected $areaTrabajoAccidente;
	protected $observacionesTrabajoAccidente;
	...
	public function setInstitutoSeguridad($institutoSeguridad){
		$this->institutoSeguridad = (string) $institutoSeguridad;
		return $this;
	}
	public function getInstitutoSeguridad(){
		return $this->institutoSeguridad;
	}

	public function setFechaTrabajoAccidente($fechaTrabajoAccidente)
	{
	  $this->fechaTrabajoAccidente = (String) $fechaTrabajoAccidente;
	    return $this;
	}

	public function getFechaTrabajoAccidente()
	{
		return $this->fechaTrabajoAccidente;
	}


	public function setPuestoTrabajoAccidente($puestoTrabajoAccidente){
		$this->puestoTrabajoAccidente = (string) $puestoTrabajoAccidente;
		return $this;
	}
	public function getPuestoTrabajoAccidente(){
		return $this->puestoTrabajoAccidente;
	}

	public function setAreaTrabajoAccidente($areaTrabajoAccidente){
		$this->areaTrabajoAccidente = (string) $areaTrabajoAccidente;
		return $this;
	}
	public function getAreaTrabajoAccidente(){
		return $this->areaTrabajoAccidente;
	}

	public function setObservacionesTrabajoAccidente($observacionesTrabajoAccidente){
		$this->observacionesTrabajoAccidente = (string) $observacionesTrabajoAccidente;
		return $this;
	}
	public function getObservacionesTrabajoAccidente(){
		return $this->observacionesTrabajoAccidente;
	}
	/**
