	...
	public function guardarAntecedentesDetalle(Array $datos){
		try{
			...
			$detalleAntecedSalud = array(
				...
				'menarquia' => (isset($datos['menarquia'])) ? $datos['menarquia'] : NULL,
				...
				'tipo_planificacion_familiar' => (isset($datos['tipo_planificacion_familiar'])) ? $datos['tipo_planificacion_familiar'] : NULL
				);
