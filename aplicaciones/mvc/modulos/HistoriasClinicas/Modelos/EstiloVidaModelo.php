...
class EstiloVidaModelo extends ModeloBase{
	 ...
	 * @var String Campo requerido
	 *      Campo visible en el formulario
	 *      tiempoCantidad de la actividad
	 */
	protected $tiempoCantidad;
	 ...
	 * tiempoCantidad de la actividad
	 *
	 * @parámetro String $tiempoCantidad
	 * @return tiempoCantidad
	 */
	public function setTiempoCantidad($tiempoCantidad){
		$this->tiempoCantidad = (string) $tiempoCantidad;
		return $this;
	}
	 ...
	 * @return null|String
	 */
	public function getTiempoCantidad(){
		return $this->tiempoCantidad;
	}

	/**
	 * Set actividadMedicina
	 *
	 * actividadMedicina
	 *
	 * @parámetro String $actividadMedicina
	 * @return actividadMedicina
	 */
	public function setActividadMedicina($actividadMedicina){
		$this->actividadMedicina = (string) $actividadMedicina;
		return $this;
	}

	/**
	 * Get actividadMedicina
	 *
	 * @return null|String
	 */
	public function getActividadMedicina(){
		return $this->actividadMedicina;
	}
	...
	public function setConfirmaEstilo($confirmaEstilo){
		$this->confirmaEstilo = (string) $confirmaEstilo;
		return $this;
	}

	public function getConfirmaEstilo(){
		return $this->confirmaEstilo;
	}
