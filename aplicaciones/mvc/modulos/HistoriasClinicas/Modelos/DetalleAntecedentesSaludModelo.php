...
class DetalleAntecedentesSaludModelo extends ModeloBase{
	...
	protected $menarquia;
	protected $tipoPlanificacionFamiliar;
	...
	public function setTipoPlanificacionFamiliar($tipoPlanificacionFamiliar){
		$this->tipoPlanificacionFamiliar = (string) $tipoPlanificacionFamiliar;
		return $this;
	}

	public function getTipoPlanificacionFamiliar(){
		return $this->tipoPlanificacionFamiliar;
	}
