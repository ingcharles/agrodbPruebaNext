...
//**************************modificado el 02-03-2021********************************
     ...
     * @return array|ResultSet
     */
    public function obtenerPerfilesXAplicacionesXTipoUsuario($idArea, $idAplicacion, $tipoUsuario=null)
    {
        $busqueda = '';
        if($tipoUsuario!=null){
     ...
     * @return array|ResultSet
     */
    public function obtenerPerfilesFaltantesXAplicaciones($idAplicacion, $identificador)
    {
        $consulta = "SELECT
                        up.id_perfil
                    FROM
