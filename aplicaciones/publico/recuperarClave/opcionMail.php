	...
	case 'verificarMail':
		...
		if(pg_num_rows($resultadoMail)==0){
			...
			$cuerpoMensaje = '<table><tbody>
							...
							<tr><td style="'.$familiaLetra.'; padding-top:5px; font-size:14px;color:#2a2a2a;">Puede acceder directamente a travez de este link <a href="http://181.112.155.163/agrodbPrueba/aplicaciones/publico/recuperarClave/recuperarClave.php?id='.md5($identificador).'">Click aqui</a></td></tr>
