...
if(pg_num_rows($resultadoCodigo)==0){
	...
	echo "<script type='text/javascript'>alert('Su contraseña ha sido cambiada correctamente.'); $(location).attr('href','http://181.112.155.163/agrodbPrueba');</script>";//https://guia.agrocalidad.gob.ec
}
