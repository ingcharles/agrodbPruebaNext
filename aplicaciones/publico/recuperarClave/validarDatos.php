...
<html>
	...
	<body>
	    <header>
	    	<div>
	    		...
	    		<h2 class="encabezado2"> <a href="http://181.112.155.163/agrodbPrueba/ingreso.php">INICIAR SESIÓN</a></h2>
	    	</div>
	    </header>
	...
	<script type="text/javascript">
		...
		$("#cancelar").click(function(event){
			$(location).attr('href','http://181.112.155.163/agrodbPrueba'); //https://guia.agrocalidad.gob.ec
		});
