...
header("Content-Disposition: attachment; filename=REPORTE_EVALUACION_CUESTIONARIO.xls");
...
$res = $cr->generarReporteEvaluacionesCuestionario($conexion, $idEvaluacion, $fechaInicio, $identificador);
?>
...
<div id="tabla">
    <table id="tablaReporte" class="soloImpresion">
        ...
        While ($fila = pg_fetch_assoc($res)) {
            ...
            echo "<td>" . $fila['aplicantes'] . "</td>";
            echo "<td>" . $fila['pregunta'] . "</td>";
            echo "<td>" . $fila['respuesta'] . "</td>";
            echo "<td>" . $fila['valor'] . "</td>";
            echo "<td>" . $fila['fecha_respuesta'] . "</td>";
