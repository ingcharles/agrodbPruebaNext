...
<header>
    <nav>
        <form id="formularioUsuario" data-rutaAplicacion='evaluaciones' data-opcion='' data-destino="detalleItem" action="aplicaciones/evaluaciones/generarReporteEvaluacionCuestionario.php" method="post">
			<input type='hidden' id='tipo' name='tipo' value="Externa" />
			<input type='hidden' id='opcion' name='opcion' value="reporteExterno" />
