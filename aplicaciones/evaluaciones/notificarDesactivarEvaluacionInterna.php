...
<header>
	<h1>Confirmar desactivación de evaluación</h1>
</header>

<div id="estado"></div>

	<p>La siguiente <b>evaluación</b> va a ser desactivada: </p>
...
<form id="notificarReactivarEvaluacion" data-rutaAplicacion="evaluaciones" data-opcion="desactivarEvaluaciones" data-accionEnExito="ACTUALIZAR" >
	 ...
	 <button id="eliminar" type="submit" >Desactivar evaluación</button>
