...
<?php
	...
	$qIdSitio = $cr->guardarNuevoSitio($conexion,$datos['codigoCatastral'], $datos['nombreSitio'], $provincia['nombre'], $canton['nombre'], $parroquia['nombre'], $datos['direccion'], $datos['referencia'], $datos['superficieTotal'], $_SESSION['usuario'], $datos['telefono'], $datos['latitud'], $datos['longitud'], $codigoSitio, $datos['archivo']);
