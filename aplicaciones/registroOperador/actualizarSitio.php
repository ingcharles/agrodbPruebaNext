...
try{
	...
	try {
		...
		if( pg_num_rows($sitiosOperacion) > 0){
			...
			$cr->actualizarSitio($conexion, $datos['codigoCatastral'], $datos['nombreSitio'], $datos['superficieTotal'], $provincia['nombre'], $canton['nombre'], $parroquia['nombre'], $datos['direccion'], $datos['referencia'], $datos['latitud'], $datos['longitud'], $datos['zona'], $datos['telefono'], $idSitio, $identificador, substr($provincia['codigo_vue'],1), $secuencialSitio);
