<?php
	...
	if($_POST['id'] == '_agrupar' and $_POST['elementos'] == null){
		echo "<div class='mensajeInicial'>Debe seleccionar la menos una operacion.</div>";
		exit();
	}
		...
		switch($areaOperacion){
			...
			case 'AI':
			    ...
			    switch($codigoOperacion){
			        ...
			        break;
				case 'MDC':
			            $mensaje = "<b>NOTA:</b> El literal A es obligatorio en caso de registrar un vehículo con PLACA.";
			        break;
	...
	<form id="guardarDocumentos" data-rutaAplicacion='registroOperador' data-opcion='guardarDocumentoOperacion' data-destino="detalleItem">
	    ...
	    <fieldset>
	        <legend>Documento anexo</legend>
	            <?php
	                ...
	                $html .= '<tr> <td colspan="3"> Archivos adjuntos para las operaciones: <span style="color:darkred">' . $idOperaciones . ' </span> </td> </tr>';
		...
		<div id="popup" style="display: none;">
    		<div class="content-popup">
		           <h3>CONFIRMACIÓN DE ANEXOS</h3>
		           <label style="color:darkred;"><br/>Verifique que la información que se va a anexar sea la correcta, si existe un error en la carga de los archivos, todas las operaciones se enviarán a subsanación. </label>
		           <br/>
