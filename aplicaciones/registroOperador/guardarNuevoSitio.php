...
try{
	$datos = array('nombreSitio' => htmlspecialchars ($_POST['nombreSitio'],ENT_NOQUOTES,'UTF-8'), 
				...
				'codigoCatastral' => htmlspecialchars ($_POST['codigo_catastral'],ENT_NOQUOTES,'UTF-8'),
	...
	try {
		...
		$qIdSitio = $cr->guardarNuevoSitio($conexion,$datos['codigoCatastral'], $datos['nombreSitio'], $provincia['nombre'], $canton['nombre'], $parroquia['nombre'], $datos['direccion'], $datos['referencia'], $datos['superficieTotal'], $identificador, $datos['telefono'], $datos['latitud'], $datos['longitud'], $secuencialSitio, $datos['archivo'], $datos['zona'], substr($provincia['codigo_vue'],1));
