...
$qProveedoresOrganico = $cro->listarOperacionesOperadorXAreaTematicaOperacionXCodigoTipoOperacion($conexion, $identificadorOperador, " in ('declararProveedor', 'subsanacionProducto')", 400, 0, 'AI', " in ('COM', 'PRC')");
