	...
	<fieldset>
		<legend>Información del Sitio</legend>
			...
			<label>Código catastral</label> 
				<input type="text" id="codigo_catastral" name="codigo_catastral" placeholder="Ej: 5687845" maxlength="32"  value="<?php echo $sitio['codigo_catastral'];?>" disabled="disabled" />
			</div>
			<div data-linea="4">
...
<script type="text/javascript">
	...
	$("#modificar").click(function(){
		...
		if (<?php echo $modificar?> == 1){ 
			...
			$("#codigo_catastral").removeAttr("disabled");
