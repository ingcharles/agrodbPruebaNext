...
class ControladorMail{
	...
	public function enviarMail($conexion, $destinatarios,$asunto, $cuerpoMensaje, $adjuntos=null){
		...
		try {                                   
			...
			$mail->Port = 587;
			$mail->SMTPAuth = true;
			$mail->Username = 'sistemaguia.agrocalidad.gob@gmail.com';
			$mail->Password = 'Agro2022';
			$mail->SMTPSecure = 'tls';
			$mail->SetFrom('sistemaguia.agrocalidad.gob@gmail.com', 'Sistema integrado G.U.I.A. AGROCALIDAD');*/
			
			$mail->Host = 'smtp.office365.com';          
			$mail->Port = 587;                                   
			$mail->SMTPAuth = true;     
			$mail->Username = 'informacion.guia@agrocalidad.gob.ec'; //$correo['direccion_correo'];    
			$mail->Password = 'Agr0M@il2022.';//$clave;                      
			$mail->SMTPSecure = 'tls';                          
			$mail->SetFrom(/*$correo['direccion_correo']*/'informacion.guia@agrocalidad.gob.ec', 'Sistema integrado G.U.I.A. AGROCALIDAD - PRUEBAS');
