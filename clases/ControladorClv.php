...
class ControladorClv
{
	...
	public function listarCertificados($conexion, $id_clv){
			...
			$lc = $conexion->ejecutarConsulta("select 
										...
										while ($fila = pg_fetch_assoc($lc)){
											$res[] = array(
    											    ...
    											    'tipoComponente' => $fila['tipo_componente']
											);
										}
			return $res;
		}
		...
		public function guardarDetalleCertificadoProductoP($conexion, $idCProducto,$ingrediente_activo,$concentracion, $unidad, $tipoComponente){
		    
		    $res = $conexion->ejecutarConsulta("INSERT INTO g_clv.certificado_clv_composicion_producto(
																				id_clv,ingrediente_activo,concentracion, unidad_medida, tipo_componente)
																				VALUES ($idCProducto,'$ingrediente_activo',
																				'$concentracion', '$unidad', '$tipoComponente') returning id_certificado_clv_composicion_producto;");
			return $res;
		}
		
		public function guardarDetalleCertificadoProductoV($conexion, $idCProducto,$composicion_declarada,$cantidad,$unidad,$descripcion_composicion, $tipoComponente){
					$res = $conexion->ejecutarConsulta("INSERT INTO g_clv.certificado_clv_composicion_producto(
																				...
																				'$cantidad','$unidad','$descripcion_composicion', '$tipoComponente');");
			return $res;
		}		
