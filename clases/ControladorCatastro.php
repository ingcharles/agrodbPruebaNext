...
class ControladorCatastro{
	...
	*/
	...
	public function listaFichaEmpleados($conexion,$identificador,$apellido,$nombre,$estado=null){
		...
		$res = $conexion->ejecutarConsulta("SELECT
												fe.*,
												COALESCE (f.id_area, dc.id_gestion) as id_area
											FROM
...
//----------------------------------------------------------------------------------------------
	...
	//Oficinas Ocupantes Transportes
	public function obtenerOficinaXProvincia ($conexion, $provincia){
	...
	//Ocupantes Transportes
	public function obtenerUsuarioXOficinaXProvincia ($conexion, $provincia, $oficina=null){
	    ...
	    $consulta = $conexion->ejecutarConsulta("  select
                                						distinct fe.identificador, fe.nombre , fe.apellido, dc.nombre_puesto, dc.id_gestion
                                					from
                                						g_uath.ficha_empleado fe
	...
	//Responsable Transportes
	public function obtenerDatosResponsableTransportes ($conexion, $identificador){
	    
	    $consulta = $conexion->ejecutarConsulta("  select
                                						distinct fe.identificador, fe.nombre , fe.apellido, dc.nombre_puesto, dc.id_gestion, dc.provincia, l.id_localizacion
                                					from
                                						g_uath.ficha_empleado fe
                                                        INNER JOIN g_uath.datos_contrato dc ON fe.identificador = dc.identificador
	...
	public function obtenerDatosContratoXIdentificador ($conexion, $identificador){
