	...
	public function listarSubtipoProducto ($conexion, $idTipoProducto){
		$res = $conexion->ejecutarConsulta("SELECT 
											...
											WHERE
												...
												and nombre not like '%INGREDIENTE ACTIVO GRADO TÉCNICO%'
											order by 2;");
		return $res;
	}
...
public function mostrarRequisitosFiltro($conexion, $areaTematica,$pais,$tipoRequisito,$idProducto,$nombreProducto=NULL,$partidaArancelaria=NULL){
	...
	public function listarPresentacionesPlaguicida($conexion, $partidaArancelariaVUE, $codigoProductoVUE){
	...
	public function listarUsosPlaguicidas($conexion,$idProducto){
