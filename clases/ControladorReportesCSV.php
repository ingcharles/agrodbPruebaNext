...
class ControladorReportesCSV
{
    ...
    //////////  FIN ** REPORTE DE SEGUIMIENTO CUARENTENARIO  SA **
	 ...
	 /// <summary> FUNCION QUE PERMITE GENERAR REPORTE DE  FITOSANITARIO DE EXPORTACIÓN</summary>  
    /// <summary> Kleber Armijos 23/01/2023 CC: optimizacion de reportes</summary>    
    /// <param name="fechaInicio">Fecha de inicio de la busqueda en bd</param>
    /// <param name="fechaFin">Fecha de fin de busqueda en la bd</param>
    /// <returns>UN RECORD(TABLA)de lo datos a mostrar en el reporte</returns>    
    public function generarReporteFitosanitarioExportacion($conexion, $fechaInicio, $fechaFin)
    {        
    ...
    /// <summary> FUNCION QUE PERMITE GENERAR REPORTE DE  IMPORTACION SANIDAD ANIMAL 2</summary>  
    /// <summary> Kleber Armijos 24/01/2023 CC: optimizacion de reportes</summary>    
    /// <param name="fechaInicio">Fecha de inicio de la busqueda en bd</param>
    /// <param name="fechaInicio">Fecha de Inicio de busqueda en la bd</param>
    /// <returns>UN RECORD(TABLA)de lo datos a mostrar en el reporte</returns>    
    public  function generarReporteImportacionSanidadAnimal($conexion, $fechaInicio, $fechaFin, $tipoReporte)
    {        
        $fechaInicio = ("'".$fechaInicio."'");
        $fechaFin = ("'".$fechaFin."'");
    ...
    /// <summary> FUNCION QUE PERMITE GENERAR REPORTE DE  IMPORTACION SV CON SUBSANACIONES</summary>  
    /// <summary> Kleber Armijos 24/01/2023 CC: optimizacion de reportes</summary>    
    /// <param name="fechaInicio">Fecha de inicio de la busqueda en bd la busqueda sera la 
    ///        data mayor a la fecha de parametro ingresada</param>    
    /// <returns>UN RECORD(TABLA)de lo datos a mostrar en el reporte</returns>    
    public function generarReporteImportacionSvConSubsanacion($conexion, $fechaInicio,$fechaFin)
    {        
        $fechaInicio = ("'".$fechaInicio."'");
        $fechaFin = ("'".$fechaFin."'");
    ...
    /// <summary> FUNCION QUE PERMITE GENERAR REPORTE DE IMPORTACIONES CON INGREDIENTE ACTIVO REGISTRO DE INSUMOS</summary>  
    /// <summary> Kleber Armijos 24/01/2023 CC: optimizacion de reportes</summary>    
    /// <param name="fechaInicio">Fecha de inicio de la busqueda en bd</param>
    /// <param name="fechaFin">Fecha de fin de busqueda en la bd</param>
    /// <returns>UN RECORD(TABLA)de lo datos a mostrar en el reporte</returns>    
    public function generarReporteImportacionIngredientesActivo($conexion, $fechaInicio, $fechaFin,$codigoArea)
    {        
        $fechaInicio = ("'".$fechaInicio."'");
        $fechaFin = ("'".$fechaFin."'");
        $codigoArea = ("'".$codigoArea."'");
        $consulta = "SELECT * from g_importaciones.fs_reporte_importaciones_con_ingrediente_activo_registro($fechaInicio, $fechaFin,$codigoArea)";       
        $res = $conexion->ejecutarConsulta($consulta);
        return $res;    
    }

     /// <summary> FUNCION QUE PERMITE GENERAR REPORTE DE OPERADORES CON DIFERENTE TIPO DE PARAMETROS</summary>  
    /// <summary> Kleber Armijos 24/01/2023 CC: optimizacion de reportes</summary>    
    /// <param name="fechaInicio">Fecha de inicio de la busqueda en bd</param>
    /// <returns>UN RECORD(TABLA)de lo datos a mostrar en el reporte</returns>    
    public function generarReporteOperadorParametrizado($conexion, $fechaInicio, $fechaFin,$tipoOperacionArea)
    {      
        set_time_limit(300);  
        $fechaInicio = ("'".$fechaInicio."'");
        $fechaFin = ("'".$fechaFin."'");
        $tipoOperacionArea = ("'".$tipoOperacionArea."'");
        $consulta = "select *from g_operadores.fs_retorna_reporte_operadores_parametrizado($fechaInicio,$fechaFin,$tipoOperacionArea);";       
        $res = $conexion->ejecutarConsulta($consulta);

        return $res;    
    }

     /// <summary> FUNCION QUE PERMITE GENERAR REPORTE DE LAS ACTIVIDADES DE MANEJO INTEGRADO</summary>  
    /// <summary> Kleber Armijos 26/09/2023 PRY-2022-009</summary>    
    /// <param name="fechaInicio">Fecha de inicio de la busqueda en bd</param>
    /// <returns>UN RECORD(TABLA)de lo datos a mostrar en el reporte</returns>    
  
    public function generarReporteActividadManejoIntegrado($conexion, $fechaInicio, $fechaFin)
    {      
        set_time_limit(300);  
        $fechaInicio = ("'".$fechaInicio."'");
        $fechaFin = ("'".$fechaFin."'");
        $consulta = "select *from f_inspeccion.reporte_manejo_integrado_actividad($fechaInicio,$fechaFin);";       
        $res = $conexion->ejecutarConsulta($consulta);
