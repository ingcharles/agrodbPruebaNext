...
//-------------------------cobro dinero electronico validar informacion-----------------------------------------
 public function cobroDineroElectronicoPre($monto, $cedula, $celular,$opcion){
 	...
 	$url='https://172.22.17.71:8443/mts_bce/services/MTSService?wsdl'; //-----Quito
 ...
 public function cobroDineroElectronicoConfirm($monto, $cedula, $celular,$opcion){
 	...
 	try {
        ...
        $cash->dtoRequestCobroConfirm->msisdnTarget = "MAAGROCALI1";
 		$cash->dtoRequestCobroConfirm->password = "e047b2502e";
 		$cash->dtoRequestCobroConfirm->pin = "e047b2502e";
 		$cash->dtoRequestCobroConfirm->user = "MAAGROCALI1";
