...
public function listarSeguimientosRemitidosAdministrador ($conexion,$idArea,$subproceso,$asunto, $fechaInicio,$fechaFin, $estado){
	...
	public function reiniciarCatalogoObjetivosEstrategicos($conexion,$anioActual,$anioAnterior){
	...
	public function reiniciarCatalogoProcesos($conexion,$anioActual,$anioAnterior){
	...
	public function reiniciarCatalogoSubprocesos($conexion,$anioActual,$anioAnterior){
	...
	public function reiniciarCatalogoActividades($conexion,$anioActual,$anioAnterior){
