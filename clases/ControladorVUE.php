...
require_once 'ControladorImportacionMuestras.php';																 
...
//INFORMACIÓN DE CONEXIÓN A SERVIDOR VUE
define('IP_SERVIDOR_VUE',$const::IP_SERVIDOR_VUE); //*
define('PUERTO_SERVIDOR_VUE',$const::PUERTO_SERVIDOR_VUE);
define('BASE_VUE',$const::BASE_VUE); //*
define('USUARIO_VUE',$const::USUARIO_VUE);
define('CLAVE_VUE',$const::CLAVE_VUE);
define('RUTA_ARCHIVOS_VUE', $const::RUTA_ARCHIVOS_VUE);//RUTA_SERVIDOR_VUE
define('RUTA_CORTA_ARCHIVOS_VUE', $const::RUTA_CORTA_ARCHIVOS_VUE);//RUTA_CORTA_SERVIDOR_VUE carpeta
...
class ControladorVUE{
	...
	public function __construct(){
		...
		$this->conexionVUE = new Conexion(IP_SERVIDOR_VUE,PUERTO_SERVIDOR_VUE,BASE_VUE,USUARIO_VUE,CLAVE_VUE);
	}
	...
	public function cargarSolicitudesPorAtenderVUE($conexionVUE){
		...
		$estado = " estado not in ('Atendida', 'W','Reverso') ORDER BY fecha asc LIMIT 25 ";
	...
	public function instanciarFormulario($formulario){
		...
		switch (substr($formulario['formulario'],0,7)){
			...
			case '101-061':
			    ...
			    break;
			case '101-062':
			    return new ImportacionMuestras($formulario['formulario'],$formulario['id'],$formulario['codigo_procesamiento'],$formulario['codigo_verificacion'],$formulario['solicitud'], $this->conexionVUE);
			    break;
			default:
				return null;
		}
	...
	public function crearAnexoRequisitos($formulario){
		...
		switch (substr($formulario->formulario,0,7)){
			...
			case '101-062':
			    ...
			    $controladorImportacionMuestras = new ControladorImportacionMuestras();
			    
			    $solicitud = $formulario->numeroDeSolicitud;
			    $identificadorImportador = $formulario->f062['impr_idt_no'];
			    
			    $idImportacion = pg_fetch_result($controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorImportador, $solicitud),0,'id_importacion_muestras');
			    
			    //Documento FPDF
			    $pdf->AliasNbPages();
			    $pdf->AddPage();
			    $pdf->Body($idImportacion,'ImportacionMuestras');
			    $pdf->SetFont('Times','',12);
			    
			    
			    $pdf->Output("../importacionMuestras/archivos/ImportacionMuestras_".$idImportacion.".pdf");
			    
			    $informeRequisitos = "aplicaciones/importacionMuestras/archivos/ImportacionMuestras_".$idImportacion.".pdf";
			    
			    //Actualizar registro
			    $controladorImportacionMuestras->guardarRutaCertificado($conexionGUIA, $idImportacion, $informeRequisitos);
			    
			    $informeRequisitos = "aplicaciones/importacionMuestras/archivos/ImportacionMuestras_".$idImportacion.".pdf";

			    //Enviar archivo adjunto VUE
			    $cFTP->enviarArchivo($informeRequisitos, 'ImportacionMuestras_'.$idImportacion.'.pdf', 'ImportacionMuestras');
	...
	public function guardarTasa($formulario){
		...
		switch (substr($formulario->formulario,0,7)){
			...
			case '101-062':
			    ...
			    $qIdImportacion = $controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorImportador, $solicitud);
			    $idImportacion = pg_fetch_result($qIdImportacion,0,'id_importacion_muestras');
			    
			    $qFinanciero = $controladorRevisionSolicitudesVUE->buscarIdImposicionTasaXSolicitud($conexionGUIA, $idImportacion, 'ImportacionMuestrasVUE', 'Financiero');
			    $financiero = pg_fetch_assoc($qFinanciero);
			    
			    $tipoSolicitudC = 'ImportacionMuestrasVUE';
			    $idSolicitudC = $idImportacion;
			    $estadoFactura = 3;
	...
	public function envioAUCP($formulario){
		...
		case '101-062':
			    ...
			    $qImportacion = $controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $formulario->f062['impr_idt_no'], $formulario->f062['req_no']);
			    $importacion = pg_fetch_assoc($qImportacion);
			    
			    $nombreImportador = str_replace("'", " ", $formulario->f062['impr_nm']);
			    $razonSocialSolicitante = str_replace("'", " ", $formulario->f062['dclr_nm']);
			    ...
			    $res = $this->conexionVUE->ejecutarConsulta("INSERT INTO vue_gateway.tn_rci_imex_uni_dcp
																			...
																			VALUES
																			(
																				'".$formulario->f062['req_no']."', '".$formulario->f062['dcm_no']."', '".$formulario->f062['dcm_nm']."', '9', 'IMP', '101', 'AGR',
																				'".$formulario->f062['req_city_cd']."', '".$formulario->f062['req_city_nm']."', '".$formulario->f062['req_de']."', '".$formulario->f062['req_no']."',
																				'".$importacion['fecha_inicio_vigencia']."', '".$importacion['fecha_inicio_vigencia']."', '".$importacion['fecha_fin_vigencia']."',
																				'".$formulario->f062['impr_cl_cd']."','', '".$formulario->f062['dclr_idt_no']."',
																				'".$razonSocialSolicitante."', '".$formulario->f062['dclr_prvhc_cd']."', '".$formulario->f062['dclr_prvhc_nm']."', '".$formulario->f062['dclr_cuty_cd']."',
																				'".$formulario->f062['dclr_cuty_nm']."', '".$formulario->f062['dclr_prqi_cd']."', '".$formulario->f062['dclr_prqi_nm']."', '".$formulario->f062['dclr_ad']."',
																				'".$formulario->f062['dcrl_tel_no']."', '".$formulario->f062['dclr_em']."', '".$formulario->f062['impr_cl_cd']."',
																				'".$formulario->f062['impr_idt_no']."', '".$nombreImportador."',
																				'".$formulario->f062['impr_cuty_cd']."', '".$formulario->f062['impr_cuty_nm']."', '".$formulario->f062['impr_prqi_cd']."', '".$formulario->f062['impr_prqi_nm']."',
																				'".$formulario->f062['impr_ad']."', 'EC', 'ECUADOR', 'Sin observaciones',
																				'S', now(), '".$formulario->f062['rgsp_id']."', '".$formulario->f062['mdf_dt']."', '".$formulario->f062['mdfr_id']."', '".$razonSocialSolicitante."', 'IMPMUES'
																			);");
			    
			    for ($i = 0; $i < count ($formulario->f062pd); $i++) {
			        ...
			        $res = $this->conexionVUE->ejecutarConsulta("INSERT INTO vue_gateway.tn_rci_imex_uni_dcp_pd
																			...
																			VALUES
																			(
																				'".$formulario->f062pd[$i]['req_no']."', '".$formulario->f062pd[$i]['prdt_sn']."', '".$formulario->f062pd[$i]['hc']."',
																				'".$formulario->f062pd[$i]['nm_pdt']."', '', ".$formulario->f062pd[$i]['weg_pdt'].", '".$formulario->f062pd[$i]['weg_und']."',
																				 ".$formulario->f062pd[$i]['cnt_pdt'].", '".$formulario->f062pd[$i]['und_md_pdt']."',
																				'S', now(), '".$formulario->f062pd[$i]['rgsp_id']."', now(), '".$formulario->f062pd[$i]['mdfr_id']."', '".$formulario->f062pd[$i]['mdfr_ip']."'
																			);");
	...
	public function  buscarResponsablesfirmas($solicitud, $areas, $tipoSolicitud, $identificadorOperador=null){
		...
		switch ($tipoSolicitud){
			...
			case 'ImportacionMuestras':
			    ...
			    $importacion = pg_fetch_assoc($controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorOperador, $solicitud));
			    $resultado = pg_fetch_assoc($controladorCatalogos->obtenerResponsableFirmaVUE($conexionGUIA, '101-062', $areas[0], $importacion['provincia_revision']));
			    $this->firmas($solicitud, $resultado['identificador']);
		...
		switch (substr($formulario->formulario,0,7)){
			...
			case '101-024':
					...
					for ($i = 0; $i < count ($detalleCLV); $i++) {
						...
						if($tipoSolicitud == 'IAP'){
							...
							$res = $this->conexionVUE->ejecutarConsulta("INSERT INTO vue_gateway.tn_agr_047_cps(req_no, dcd_cps_sn,
																												...
																												dcd_cps_conce_ut,
																												use_fg,
																												rgs_dt, rgsp_id, mdfr_ip, dcd_cps_nm)
																										VALUES
																												('$solicitud',
							...
							$res = $this->conexionVUE->ejecutarConsulta("INSERT INTO vue_gateway.tn_agr_047_cps(req_no, dcd_cps_sn,
																												dcd_cps_nm, cfg_igdt_desc,
                                                                                                                dcd_cps_qt, dcd_cps_qt_ut, 
				...
				case '101-062':
				    ...
				    $codigoCiudad = $formulario->f062['req_city_cd'];
				    $nombreCiudad = $formulario->f062['req_city_nm'];
				    $identificadorImportador = $formulario->f062['impr_idt_no'];
				    
				    $qImportacion = $controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorImportador, $solicitud);
				    $registroImportacionMuestras = pg_fetch_assoc($qImportacion);
				    
				    
				    $res = $this->conexionVUE->ejecutarConsulta("UPDATE
																vue_gateway.tn_agr_062
															SET
																dcm_no = '101-062-RES',
																ctft_no='$solicitud', --Número certificado
																ctft_iss_city_cd='$codigoCiudad', -- codigo de ciudad de emision
																ctft_iss_city_nm='$nombreCiudad', --nombre de ciudad de emision
																req_eftv_stdt='".$registroImportacionMuestras['fecha_inicio_vigencia']."', --fecha de inicio de vigencia del certificado
																req_eftv_finl_de='".$registroImportacionMuestras['fecha_fin_vigencia']."' --fecha de final de vigencia de certificador
															WHERE
																req_no ='$solicitud';");
				    
				    //Revisar cuando envíen los códigos de los productos para poner las áreas temáticas!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
				    $tipoSolicitudVUE = strtoupper($formulario-> f062['req_type_cd']);
				    $areas[] = ($tipoSolicitudVUE == '0001'?'SA': ($tipoSolicitudVUE == '0002'?'SV': ($tipoSolicitudVUE == '0003'?'IAV': ($tipoSolicitudVUE == '0004'?'IAPQ': ($tipoSolicitudVUE == '0005'?'IAPB': ($tipoSolicitudVUE == '0006'?'IAF': 'No definido'))))));
				    
				    $this->buscarResponsablesfirmas($solicitud, array_unique($areas), 'ImportacionMuestras',$identificadorImportador);
		...
		switch (substr($formulario->formulario,0,7)){
			...
			case '101-002':
				...
				case '101-062':
				    ...
				    $this->buscarResponsablesfirmas($solicitud, array_unique($areas), 'ImportacionMuestrasVUE',$identificadorImportador);
	...
	public function enviarDocumentoAdjuntos($formulario, $codigoVerificacion, $ruta){
		...
		switch (substr($formulario->formulario,0,7)){
			...
			case '101-062':
			    ...
			    $importacion = $controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $formulario->f062['impr_idt_no'], $formulario->f062['req_no']);
			    $registroImportacionMuestras = pg_fetch_assoc($importacion);
			    
			    $archivo = explode('/', $registroImportacionMuestras['informe_requisitos']);
			    
			    $nombreArchivo = end($archivo);
			    $idVue = $formulario->f062['req_no'];
...
abstract class FormularioVUE{
	...
	public function verificarProductoMuestraRepetido($arrayFormularioProductos){
	    //Esta función es solamente para Importación de muestras
	    $resultadoProducto = false;
	    
	    $arrayProductos = array(); // creo el array
	    
	    for ($i = 0; $i < count ($arrayFormularioProductos); $i++) {
	        $arrayProductos[] = $arrayFormularioProductos[$i]['hc'].$arrayFormularioProductos[$i]['nm_pdt'];
	    }
	    
	    $arrayProductosSinRepetidos = array_unique($arrayProductos);
	    
	    
	    if (count($arrayProductos)!= count($arrayProductosSinRepetidos)){
	        $resultadoProducto = true;
	    }
...
class Importaciones extends FormularioVUE{
	...
	public function insertarDatosEnGUIA(){
		...
		for ($i = 0; $i < count ($this->f002pd); $i++) {
			...
			if($area == "IAP"){			    
			    $qPresentacionProducto = $controladorCatalogos->obtenerCodigosComplementariosSuplementariosPlaguicidas($conexionGUIA, $producto['id_producto'], $partidaArancelariaVUE, $codigoProductoVUE);
			    $presentacionProducto = pg_fetch_assoc($qPresentacionProducto);
			    
			    $presentacion = $presentacionProducto['presentacion'].' '.$presentacionProducto['unidad'];
			    
			}else{
			    $qPresentacionProducto = $controladorCatalogos->buscarCodigoInocuidad($conexionGUIA, $producto['id_producto'], $codigoInocuidad);
			    $presentacionProducto = pg_fetch_assoc($qPresentacionProducto);
			    
			    $presentacion = $presentacionProducto['presentacion'].' '.$presentacionProducto['unidad_medida'];
			}
			...
			$controladorImportaciones -> guardarImportacionesProductos($conexionGUIA, pg_fetch_result($idImportacion, 0, 'id_importacion'), $producto['id_producto'], $producto['nombre_comun'], $this->f002pd[$i]['prdt_qt'], $this->f002pd[$i]['prdt_nwt'], $this->f002pd[$i]['fobv_val'], 
																		$this->f002pd[$i]['cif_val'], $this->f002['prvw_lcs_ctft_no'] , $this->f002pd[$i]['prdt_rgs_no'], '',$this->f002pd[$i]['prdt_mes'], $presentacion ,$partidaArancelariaVUE, $codigoProductoVUE, 
	...
	public function insertarDocumentosAdjuntosGUIA($documentos){
		...
		if(pg_num_rows($documentos)!= 0){
			while($documentosAdjuntos = pg_fetch_assoc($documentos)){
				$ruta= explode(RUTA_CORTA_ARCHIVOS_VUE, $documentosAdjuntos['ruta']);
	...
	public function recaudacionTasa($recaudacionTasas){
		...
		if($datosTasa['banco'] == '' && $datosTasa['identificador_pago'] == '149'){
			
			$saldoDisponible = pg_fetch_assoc($controladorFinanciero->obtenerMaxSaldo($conexionGUIA, $datosTasa['identificador']));
...
class CLV extends FormularioVUE{
	...
	public function validarDatosFormulario(){
		...
		for ($i = 0; $i < count ($this->f047['req_no']); $i++) {
			...
			//Verifica que exista un operador con operaciones de RIA para ese producto registrado.
			...
			//Validación de campos nuevos para aprobación automática
			
			//Tipo de componente, Ingrediente activo, Concentracion, Unidad de medida de concentración
			$qComposicion = $controladorRequisitos->listarComposicionProductosInocuidad($conexionGUIA, $producto['id_producto']);
			
			if(pg_num_rows($qComposicion) == 0 ){
			    $solicitudEsValida = false;
			    echo IN_MSG. "El producto  ".$this->f047['prdt_nm']." no cuenta con información de Tipo de componente, Ingrediente activo, Concentración";
			    $resultado[0] = SUBSANACION_REQUERIDA;
			    $resultado[1] = "El producto  ".$this->f047['prdt_nm']." no cuenta con información de Tipo de componente, Ingrediente activo, Concentración";
			    break;
			}
			
			//Usos registrados			
			if($area == 'IAV'){
			    $qUsos = $controladorRequisitos->listarUsos($conexionGUIA, $producto['id_producto']);
			    
			    //Revisa que existan usos
			    if(pg_num_rows($qUsos) == 0 ){
			        $solicitudEsValida = false;
			        echo IN_MSG. "El producto  ".$this->f047['prdt_nm']." no cuenta con Usos registrados IAV";
			        $resultado[0] = SUBSANACION_REQUERIDA;
			        $resultado[1] = "El producto  ".$this->f047['prdt_nm']." no cuenta con Usos registrados IAV";
			        break;
			    }else{//Y dentro de los usos, por lo menos uno asignado a una especie animal
			        $especie = array();
			        
			        while ($fila = pg_fetch_assoc($qUsos)) {
			            if($fila['id_especie']){
			                $especie[] = $fila['nombre'];
			            }			            
			        }
			        ...
			        if(count($especie) == 0){
			            $solicitudEsValida = false;
			            echo IN_MSG. "El producto  ".$this->f047['prdt_nm']." no cuenta con Usos registrados para una especie IAV";
			            $resultado[0] = SUBSANACION_REQUERIDA;
			            $resultado[1] = "El producto  ".$this->f047['prdt_nm']." no cuenta con Usos registrados para una especie IAV";
			            break;
			        }
			        
			    }
			}else if($area == 'IAP'){
			    $qUsos = $controladorRequisitos->listarUsosPlaguicidas($conexionGUIA, $producto['id_producto']);
			    
			    if(pg_num_rows($qUsos) == 0 ){
			        $solicitudEsValida = false;
			        echo IN_MSG. "El producto  ".$this->f047['prdt_nm']." no cuenta con Usos registrados IAP";
			        $resultado[0] = SUBSANACION_REQUERIDA;
			        $resultado[1] = "El producto  ".$this->f047['prdt_nm']." no cuenta con Usos registrados IAP";
			        break;
			    }
			}
			...
			if($area == 'IAV'){
			    $qPresentacion = $controladorRequisitos->listarCodigoInocuidad($conexionGUIA, $producto['id_producto']);
			    
			    if(pg_num_rows($qPresentacion) == 0 ){
			        $solicitudEsValida = false;
			        echo IN_MSG. "El producto  ".$this->f047['prdt_nm']." no cuenta con Presentaciones registradas IAV";
			        $resultado[0] = SUBSANACION_REQUERIDA;
			        $resultado[1] = "El producto  ".$this->f047['prdt_nm']." no cuenta con Presentaciones registradas IAV";
			        break;
			    }
			}else if($area == 'IAP'){
			    $qPresentacion = $controladorRequisitos->listarPresentacionesPlaguicida($conexionGUIA, $partidaArancelariaVUE, $codigoProductoVUE);
			    
			    if(pg_num_rows($qPresentacion) == 0 ){
			        $solicitudEsValida = false;
			        echo IN_MSG. "El producto  ".$this->f047['prdt_nm']." no cuenta con Presentaciones registradas IAP";
			        $resultado[0] = SUBSANACION_REQUERIDA;
			        $resultado[1] = "El producto  ".$this->f047['prdt_nm']." no cuenta Presentaciones registradas IAP";
			        break;
			    }
			}
			
			//Fabricante o Formulador registrados
			$qFabricanteFormulador = $controladorRequisitos->listarFabricanteFormulador($conexionGUIA, $producto['id_producto']);
			
			if(pg_num_rows($qFabricanteFormulador) == 0 ){
			    $solicitudEsValida = false;
			    echo IN_MSG. "El producto  ".$this->f047['prdt_nm']." no cuenta con Fabricantes o Formuladores registrados";
			    $resultado[0] = SUBSANACION_REQUERIDA;
			    $resultado[1] = "El producto  ".$this->f047['prdt_nm']." no cuenta con Fabricantes o Formuladores registrados";
			    break;
			}
	...
	public function insertarDatosEnGUIA(){
		...
		if(pg_num_rows($qIdCLV) == 0){
			...
			$qIdCLV= $controladorCLV->guardarCertificadoProducto($conexionGUIA,$datosT['identificador_titulares'],$area, $ctipo_datos_certificado,$codigoCertificado,
																$producto['id_producto'],$producto['nombre_comun'],'aprobado', $this->f047['prdt_fml_desc'] ,$this->f047['req_no'], $partidaArancelariaVUE, $codigoProductoVUE);

			//Consulta de datos del producto
			$datosProducto = $controladorCLV->listaProdInocuidad($conexionGUIA, pg_fetch_result($qIdCLV, 0, 'id_clv'));
			
			//Inserción de nuevos datos de formulario CLV
			if($area == 'IAP'){
			    
			    $fechaVencimiento = date('Y/m/d',strtotime(date("Y/m/d")."+ 6 month" ));
			    
			    $controladorCLV->actualizarClvPlaguicida($conexionGUIA, $datosT['nombre_titular'], $datosT['direccion'],
			        $partidaArancelariaVUE,$datosProducto[0]['producto'],$codigoProductoVUE,
			        $datosProducto[0]['formulacionGuia'], $datosProducto[0]['numero_registro'],'Aprobación automática GUIA',pg_fetch_result($qIdCLV, 0, 'id_clv'),
			        $datosProducto[0]['fecha_registro'], $fechaVencimiento);
			    
			}else if ($area == 'IAV'){
			    $especieProducto = $controladorRequisitos->listarUsos($conexionGUIA, $datosProducto[0]['id_producto']);
			    ...
			    $presentacionProducto = $controladorRequisitos->listarCodigoInocuidad($conexionGUIA, $datosProducto[0]['id_producto']);
			    ...
			    $presentaciones = mb_substr(implode(', ',$presentacion), 0, 1023);
			    
			    $usoProducto = implode(', ',array_unique($usoProducto));
			    
			    $controladorCLV->actualizarClvVeterinario($conexionGUIA, $datosT['nombre_titular'],$datosT['direccion'],
			        $partidaArancelariaVUE, $datosProducto[0]['producto'],
			        $presentaciones, $datosProducto[0]['clasificacion'], $datosProducto[0]['formulacionGuia'], $usoProducto,
			        $especies, $datosProducto[0]['numero_registro'],'Aprobación automática GUIA',pg_fetch_result($qIdCLV, 0, 'id_clv'),
			...
			$controladorCLV->actualizarClv($conexionGUIA, pg_fetch_result($qIdCLV, 0, 'id_clv'), $datosT['identificador_titulares'], $area, $ctipo_datos_certificado, 
											$producto['id_producto'],$producto['nombre_comun'], 'aprobado',$partidaArancelariaVUE, $codigoProductoVUE);
		...
		$composicionProducto = $controladorRequisitos->listarComposicionProductosInocuidad($conexionGUIA, $producto['id_producto']);												 
		
		while ($fila = pg_fetch_assoc($composicionProducto)){
		    $controladorCLV -> guardarDetalleCertificadoProductoP($conexionGUIA, $idCLV, $fila['ingrediente_activo'], $fila['concentracion'], $fila['unidad_medida'], $fila['tipo_componente']);
		}
		...
		$controladorVUE->ingresarSolicitudesXatenderGUIA('101-047-REQ','320','21',$this->f047['req_no'], 'Por atender');
		
		echo OUT_MSG . 'Datos de envio de aprobacion insertados';
...
class TransitoInternacional extends FormularioVUE{
    ...
    public function validarDatosFormulario(){
        ...
        for($j = 0 ; $j < count($this->f061['req_no']); $j++){
            ...
            //echo "Validación país de origen";
            ...
            //echo "Validación ciudad solicitud";
            ...
            //echo "Validación codigo país de procedencia";
			...
			//echo "Validación codigo país de destino";
        ...
        if($certificadoImpValido){
            for ($i = 0; $i < count ($this->f061pd); $i++) {
				...
				//echo "Validación Area igual SV el producto debe tener un codigo de 5 digitos";
				...
				//echo "Busqueda del producto en base de datos GUIA";
				...
				//echo "Validar la unidad de peso en KG";
				...
				//echo "Valida que el operador tenga una operacion de comercializador directo con el producto indicado";
				...
				//echo "Validar si el producto esta activo para un pais y actividad";
            }
        }
...
class ImportacionMuestras extends FormularioVUE{
    ...
    public function __construct($formulario, $id, $codigoDeProcesamiento, $codigoDeVerificacion, $numeroDeSolicitud, $coneccionVUE){
        ...
        //Trayendo los datos de cabecera del formulario 101-062
        
        $this-> f062 = pg_fetch_assoc($coneccionVUE->ejecutarConsulta("SELECT *
				FROM vue_gateway.tn_agr_062
				WHERE REQ_NO = '$numeroDeSolicitud'"));
        
        //Trayendo los datos de detalle del formulario 101-062
        
        $c_f061pd = $coneccionVUE ->ejecutarConsulta(" SELECT *
				FROM vue_gateway.tn_agr_062_pd
				WHERE REQ_NO = '$numeroDeSolicitud'");
    ...
    public function validarDatosFormulario(){
        echo  PRO_MSG. 'validando formulario 101-062';
        ...
        //parent::validarCamposObligatorios($f062,'cabecera');
        //parent::validarCamposObligatorios($f062_pd,'productos');
        ...
        $identificadorImportador = $this->f062['impr_idt_no'];
        
        $tipoSolicitudVUE = strtoupper(($this->f062['req_type_cd']));
        //Revisar cuando envíen los códigos de los productos para poner las áreas temáticas!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        $tipoSolicitudGUIA = ($tipoSolicitudVUE == '0001'?'SA': ($tipoSolicitudVUE == '0002'?'SV': ($tipoSolicitudVUE == '0003'?'IAV': ($tipoSolicitudVUE == '0004'?'IAPQ': ($tipoSolicitudVUE == '0005'?'IAPB': ($tipoSolicitudVUE == '0006'?'IAF': 'No definido'))))));
        
        for($j = 0 ; $j < count($this->f062['req_no']); $j++){
            
            //Validación ciudad solicitud
            $codigoCiudadVUE = $this->f062['req_city_nm'];
            $qCodigoCiudad = $controladorCatalogos->buscarLocalizacionXNombre($conexionGUIA, $codigoCiudadVUE);
            $codigoCiudad = pg_fetch_assoc($qCodigoCiudad);
            
            if( pg_num_rows($qCodigoCiudad) == 0 ){ //Validación de ciudad solicitud
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'La ciudad '.$this->f062['req_city_nm'].' no se encuentra registrada en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'La ciudad '.$this->f062['req_city_nm'].' no se encuentra registrada en agrocalidad';
                break;
            }
            
            //Validación provincia solicitante
            $codigoProvinciaSolicitanteVUE = $this->f062['dclr_prvhc_cd'];
            $qCodigoProvinciaSolicitante = $controladorCatalogos->obtenerCodigoLocalizacion($conexionGUIA, $codigoProvinciaSolicitanteVUE);
            $codigoProvinciaSolicitante = pg_fetch_assoc($qCodigoProvinciaSolicitante);
            
            if( pg_num_rows($qCodigoProvinciaSolicitante) == 0 ){ //Validación del pais de origen
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'La provincia del solicitante '.$this->f062['dclr_prvhc_nm'].' no se encuentra registrada en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'La provincia del solicitante '.$this->f062['dclr_prvhc_nm'].' no se encuentra registrada en agrocalidad';
                break;
            }
            
            //Validación ciudad solicitante
            $codigoCiudadSolicitanteVUE = $this->f062['impr_cuty_nm'];
            $qCodigoCiudadSolicitante = $controladorCatalogos->buscarLocalizacionXNombre($conexionGUIA, $codigoCiudadSolicitanteVUE);
            $codigoCiudadSolicitante = pg_fetch_assoc($qCodigoCiudadSolicitante);
            
            if( pg_num_rows($qCodigoCiudadSolicitante) == 0 ){ //Validación de ciudad solicitante
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'La ciudad del solicitante '.$this->f062['impr_cuty_nm'].' no se encuentra registrada en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'La ciudad del solicitante '.$this->f062['impr_cuty_nm'].' no se encuentra registrada en agrocalidad';
                break;
            }
            
            //Validación parroquia solicitante
            $codigoParroquiaSolicitanteVUE = $this->f062['dclr_prqi_cd'];
            $qCodigoParroquiaSolicitante = $controladorCatalogos->obtenerCodigoLocalizacion($conexionGUIA, $codigoParroquiaSolicitanteVUE);
            $codigoParroquiaSolicitante = pg_fetch_assoc($qCodigoParroquiaSolicitante);
            
            if( pg_num_rows($qCodigoParroquiaSolicitante) == 0 ){ //Validación parroquia solicitante
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'La parroquia del solicitante '.$this->f062['dclr_prqi_nm'].' no se encuentra registrada en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'La parroquia del solicitante '.$this->f062['dclr_prqi_nm'].' no se encuentra registrada en agrocalidad';
                break;
            }
            
            //Validación provincia importador
            $codigoProvinciaImportadorVUE = $this->f062['impr_prvhc_cd'];
            $qCodigoProvinciaImportador = $controladorCatalogos->obtenerCodigoLocalizacion($conexionGUIA, $codigoProvinciaImportadorVUE);
            $codigoProvinciaImportador = pg_fetch_assoc($qCodigoProvinciaImportador);
            
            if( pg_num_rows($qCodigoProvinciaImportador) == 0 ){ //Validación de provincia del importador
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'La provincia del importador '.$this->f062['impr_prvhc_nm'].' no se encuentra registrada en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'La provincia del importador '.$this->f062['impr_prvhc_nm'].' no se encuentra registrada en agrocalidad';
                break;
            }
            
            //Validación ciudad importador
            $codigoCiudadImportadorVUE = $this->f062['impr_cuty_nm'];
            $qCodigoCiudadImportador = $controladorCatalogos->buscarLocalizacionXNombre($conexionGUIA, $codigoCiudadImportadorVUE);
            $codigoCiudadImportador = pg_fetch_assoc($qCodigoCiudadImportador);
            
            if( pg_num_rows($qCodigoCiudadImportador) == 0 ){ //Validación de ciudad solicitante
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'La ciudad del importador '.$this->f062['impr_cuty_nm'].' no se encuentra registrada en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'La ciudad del importador '.$this->f062['impr_cuty_nm'].' no se encuentra registrada en agrocalidad';
                break;
            }
            
            //Validación parroquia importador
            $codigoParroquiaImportadorVUE = $this->f062['impr_prqi_cd'];
            $qCodigoParroquiaImportador = $controladorCatalogos->obtenerCodigoLocalizacion($conexionGUIA, $codigoParroquiaImportadorVUE);
            $codigoParroquiaImportador = pg_fetch_assoc($qCodigoParroquiaImportador);
            
            if( pg_num_rows($qCodigoParroquiaImportador) == 0 ){ //Validación parroquia solicitante
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'La parroquia del importador '.$this->f062['impr_prqi_nm'].' no se encuentra registrada en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'La parroquia del importador '.$this->f062['impr_prqi_nm'].' no se encuentra registrada en agrocalidad';
                break;
            }
            
            //Validación Régimen aduanero
            $codigoRegimenAduaneroVUE = $this->f062['cus_rgn_cd'];
            $qRegimenAduanero = $controladorCatalogos->obtenerCodigoAduanero($conexionGUIA, $codigoRegimenAduaneroVUE);
            $codigoRegimenAduanero = pg_fetch_assoc($qRegimenAduanero);
            
            if( pg_num_rows($qRegimenAduanero) == 0 ){ //Validación regimen aduanero
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'El regimen aduanero '.$this->f062['cus_rgn_nm'].' no se encuentra registrado en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'El regimen aduanero '.$this->f062['cus_rgn_nm'].' no se encuentra registrado en agrocalidad';
                break;
            }
            
            //Validación país de origen
            $codigoPaisOrigenVUE = $this->f062['org_coun_cd'];
            $qCodigoPaisOrigen = $controladorCatalogos->obtenerCodigoLocalizacion($conexionGUIA, $codigoPaisOrigenVUE);
            $codigoPaisOrigen = pg_fetch_assoc($qCodigoPaisOrigen);
            ...
            if( pg_num_rows($qCodigoPaisOrigen) == 0 ){ //Validación del pais de origen
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'El pais de origen '.$this->f062['org_coun_nm'].' no se encuentra registrado en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'El pais de origen '.$this->f062['org_coun_nm'].' no se encuentra registrado en agrocalidad';
                break;
            }
            
            //Validación medio de transporte
            $codigoMedioTransporteVUE = $this->f062['wy_trans_cd'];
            $qCodigoMedioTransporte = $controladorCatalogos->obtenerCodigoMedioTransporte($conexionGUIA, $codigoMedioTransporteVUE); //Codigo del medio transporte
            $codigoMedioTransporte = pg_fetch_assoc($qCodigoMedioTransporte);
            
            if( pg_num_rows($qCodigoMedioTransporte) == 0 ){ //Validación del medio de transporte
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'El medio de transporte '.$this->f062['wy_trans_nm'].' no se encuentra registrado en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'El medio de transporte '.$this->f062['wy_trans_nm'].' no se encuentra registrado en agrocalidad';
                break;
            }
            
            //Validación codigo país de embarque
            $codigoPaisEmbarqueVUE = $this->f062['spm_coun_cd'];
            $qCodigoPaisEmbarque = $controladorCatalogos->obtenerCodigoLocalizacion($conexionGUIA, $codigoPaisEmbarqueVUE); //Codigo del pais de embarque
            $codigoPaisEmbarque = pg_fetch_assoc($qCodigoPaisEmbarque);
            ...
            if( pg_num_rows($qCodigoPaisEmbarque) == 0 ){ //Validación del pais de embarque
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'El pais de embarque '.$this->f062['spm_coun_nm'].' no se encuentra registrado en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'El pais de embarque '.$this->f062['spm_coun_nm'].' no se encuentra registrado en agrocalidad';
                break;
            }
            
            //Puerto de embarque
            $codigoPuertoEmbarqueVUE = $this->f062['spm_prot_cd'];
            $qCodigoPuertoEmbarque = $controladorCatalogos->obtenerPuertoCodigo($conexionGUIA, $codigoPuertoEmbarqueVUE); //Obtiene codigo de puerto de ambarque
            $codigoPuertoEmbarque = pg_fetch_assoc($qCodigoPuertoEmbarque);
            
            if( pg_num_rows($qCodigoPuertoEmbarque) == 0 ){ //Validación del puerto de ingreso
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'El puerto de embarque '.$this->f062['spm_prot_nm'].' no se encuentra registrado en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'El puerto de embarque '.$this->f062['spm_prot_nm'].' no se encuentra registrado en agrocalidad';
                break;
            }
            
            //Validación codigo país de destino
            $codigoPaisDestinoVUE = $this->f062['dst_coun_cd'];
            $qCodigoPaisDestino = $controladorCatalogos->obtenerCodigoLocalizacion($conexionGUIA, $codigoPaisDestinoVUE); //Codigo del pais de Destino
            $codigoPaisDestino = pg_fetch_assoc($qCodigoPaisDestino);
            ...
            if( pg_num_rows($qCodigoPaisDestino) == 0 ){ //Validación del pais de Destino
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'El pais de destino '.$this->f062['dst_coun_nm'].' no se encuentra registrado en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'El pais de destino '.$this->f062['dst_coun_nm'].' no se encuentra registrado en agrocalidad';
                break;
            }
            
            //Puerto de destino
            $codigoPuertoDestinoVUE = $this->f062['dst_prot_cd'];
            $qCodigoPuertoDestino = $controladorCatalogos->obtenerPuertoCodigo($conexionGUIA, $codigoPuertoDestinoVUE); //Obtiene codigo de puerto destino
            $codigoPuertoDestino = pg_fetch_assoc($qCodigoPuertoDestino);
            
            if( pg_num_rows($qCodigoPuertoDestino) == 0 ){ //Validación del puerto de destino
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'El puerto de destino '.$this->f062['dst_prot_nm'].' no se encuentra registrado en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'El puerto de destino '.$this->f062['dst_prot_nm'].' no se encuentra registrado en agrocalidad';
                break;
            }
            
            //Unidad de moneda
            $codigoMonedaVUE = $this->f062['und_mnd_cd'];
            $qMonedaGUIA = $controladorCatalogos -> obtenerCodigoMoneda($conexionGUIA, $codigoMonedaVUE);
            $monedaGUIA = pg_fetch_assoc($qMonedaGUIA);
            
            if( pg_num_rows($qMonedaGUIA) == 0 ){ //Validación de unidad de moneda
                $solicitudEsValida = false;
                $certificadoImpValido = false;
                echo IN_MSG. 'La unidad de moneda '.$this->f062['und_mnd_nm'].' no se encuentra registrada en agrocalidad';
                $resultado[0] = SUBSANACION_REQUERIDA;
                $resultado[1] = 'La unidad de moneda '.$this->f062['und_mnd_nm'].' no se encuentra registrada en agrocalidad';
                break;
            }
            
            //Validacion Productos duplicados
            $productoDuplicado = parent::verificarProductoMuestraRepetido($this->f062pd);
        ...
        if($certificadoImpValido){
            for ($i = 0; $i < count ($this->f062pd); $i++) {
                
                $partidaArancelariaVUE = $this->f062pd[$i]['hc'];
                $nombreProductoVUE = $this->f062pd[$i]['nm_pdt'];
                
                //Validar unidad de medida de producto
                $codigoUnidadMedidaVUE = $this->f062pd[$i]['und_md_pdt'];                
                $qUnidadMedida = $controladorCatalogos->obtenerIdUnidadMedida($conexionGUIA, $codigoUnidadMedidaVUE); //Codigo de unidad de medida
                
                if( pg_num_rows($qUnidadMedida) == 0 ){ // Validación de unidad de medida.
                    
                    $solicitudEsValida = false;
                    echo IN_MSG. 'La unidad de medida de cantidad del producto '.$this->f062pd[$i]['und_md_pdt'].' no se encuentra registrada en Agrocalidad. ';
                    $resultado[0] = SUBSANACION_REQUERIDA;
                    $resultado[1] = 'La unidad de medida de cantidad del producto '.$this->f062pd[$i]['nmd_pdt'] . ' ' . $this->f062pd[$i]['und_md_pdt'].' no se encuentra registrada en Agrocalidad. ';
                    break;
                }
                
                //Validar la unidad de peso en KG
                
                $unidadPesoProductoVUE = $this->f062pd[$i]['weg_und'];
    ...
    public function validarActualizacionDeDatos(){
        ...
        $idVue = $this->f062['req_no'];
        $identificadorImportador = $this->f062['impr_idt_no'];
        
        $fechaActual=date('Y-m-d');
        
        for ($i = 0; $i < count ($this->f062['req_no']); $i++) {
            
            $qImportacion = $controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorImportador, $idVue);
            $datosImportador = pg_fetch_assoc($qImportacion);
            ...
            if(!(strtotime($fechaCertificado) >= strtotime($fechaActual))){
                $modificacion = false;
                echo IN_MSG. 'El certificado de importacion de muestras no se encuentra vigente.';
                $resultado[0] = SOLICITUD_DE_CORRECION_NO_APROBADA;
                $resultado[1] = 'El certificado de importacion de muestras no se encuentra vigente.';
                break;
            }
    ...
    public function insertarDatosEnGUIA(){
        ...
        //Datos solicitud
        $codigoCiudadSolicitudVUE = $this->f062['req_city_cd'];
        $nombreCiudadSolicitudVUE = $this->f062['req_city_nm'];
        ...
        parent::ingresarRegistroOperador($identificadorImportador, $this->f062['impr_nm']);
        
        
        
        //Datos de solicitud
        
        $qCodigoCiudadSolicitud = $controladorCatalogos->buscarLocalizacionXNombre($conexionGUIA, $nombreCiudadSolicitudVUE); //Codigo de ciudad de solicitud
        $codigoCiudadSolicitud = pg_fetch_assoc($qCodigoCiudadSolicitud);
        
        //Definir la provincia para revision
        $qCodigoProvinciaRevision = $controladorCatalogos->obtenerNombreLocalizacion($conexionGUIA, $codigoCiudadSolicitud['id_localizacion_padre']); //Codigo de provincia de solicitud
        $codigoProvinciaRevision = pg_fetch_assoc($qCodigoProvinciaRevision);
        ...
        //Validación provincia importador
        $codigoProvinciaImportadorVUE = $this->f062['impr_prvhc_cs'];
        $qCodigoProvinciaImportador = $controladorCatalogos->obtenerCodigoLocalizacion($conexionGUIA, $codigoProvinciaImportadorVUE);
        $codigoProvinciaImportador = pg_fetch_assoc($qCodigoProvinciaImportador);
        ...
        //Generar código de la solicitud
        $res = $controladorImportacionMuestras->generarNumeroSolicitud($conexionGUIA, '%'.$identificadorImportador.'%');
        $solicitud = pg_fetch_assoc($res);
        $tmp= explode("-", $solicitud['numero']);
        $incremento = end($tmp)+1;
        
        $codigoSolicitud = 'IMP_MUES-'.$identificadorImportador.'-'.str_pad($incremento, 7, "0", STR_PAD_LEFT);
        echo OUT_MSG . 'Generación de codigo interno de importacion de muestras';
        
        
        $importacionMuestra = $controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorImportador, $this->f062['req_no']);
        
        /*$nombreSolicitante = str_replace("'", " ", $this->f062['dclr_nm']);
        $nombreRepresentanteLegalSolicitante = str_replace("'", " ", $this->f062['dclr_rpgp_nm']);
        $nombreImportador = str_replace("'", " ", $this->f062['impr_nm']);
        */
        
        if(pg_num_rows($importacionMuestra) == 0){  
            
            $importacionMuestra = $controladorImportacionMuestras->guardarNuevoImportacionMuestras($conexionGUIA, 
                $this->f062['req_no'], $this->f062['dcm_no'], 
                $this->f062['dcm_nm'], $this->f062['dcm_func_cd'], $this->f062['req_de'], 
                $this->f062['req_city_cd'], $codigoCiudadSolicitud['nombre'], 
                $tipoSolicitudGUIA, $this->f062['req_type_nm'], $this->f062['ctft_no'], 
                $this->f062['dclr_idt_no'], $this->f062['dclr_nole'], $this->f062['dclr_rpgp_nm'], 
                $this->f062['dclr_prvhc_cd'], $this->f062['dclr_prvhc_nm'], 
                $this->f062['dclr_cuty_cd'], $this->f062['dclr_cuty_nm'], 
                $this->f062['dclr_prqi_cd'], $this->f062['dclr_prqi_nm'], 
                $this->f062['dclr_nm'], $this->f062['dclr_ad'], $this->f062['dclr_tel_no'], $this->f062['dclr_em'], 
                $this->f062['impr_idt_no'], $this->f062['impr_nm'], 
                $this->f062['impr_rpst_nm'], 
                $this->f062['impr_prvhc_cd'], $this->f062['impr_prvhc_nm'],
                $this->f062['impr_cuty_cd'], $this->f062['impr_cuty_nm'],
                $this->f062['impr_prqi_cd'], $this->f062['impr_prqi_nm'],
                $this->f062['impr_ad'], $this->f062['impr_tel_no'], $this->f062['impr_cel_no'], $this->f062['impr_em'], 
                $this->f062['expr_nm'], $this->f062['expr_ad'], 
                $this->f062['cus_rgn_cd'], $this->f062['cus_rgn_nm'], 
                $this->f062['org_coun_cd'], $this->f062['org_coun_nm'],
                $this->f062['wy_trans_cd'], $this->f062['wy_trans_nm'],
                $this->f062['spm_coun_cd'], $this->f062['spm_coun_nm'],
                $this->f062['spm_prot_cd'], $this->f062['spm_port_nm'],
                $this->f062['dst_coun_cd'], $this->f062['dst_coun_nm'], 
                $this->f062['dst_prot_cd'], $this->f062['dst_port_nm'],
                $this->f062['und_mnd_cd'], $this->f062['und_mnd_nm'], 
                $this->f062['shpr_nm'], $codigoProvinciaRevision['nombre'], $codigoSolicitud);

        }else{
            $controladorImportacionMuestras->actualizarDatosImportacionMuestras($conexionGUIA, pg_fetch_result($importacionMuestra, 0, 'id_importacion_muestras'), 
                $this->f062['req_no'], $this->f062['dcm_no'],
                $this->f062['dcm_nm'], $this->f062['dcm_func_cd'], $this->f062['req_de'],
                $this->f062['req_city_cd'], $codigoCiudadSolicitud['nombre'],
                $tipoSolicitudGUIA, $this->f062['req_type_nm'], $this->f062['ctft_no'],
                ...
                $this->f062['dst_prot_cd'], $this->f062['dst_port_nm'],
                $this->f062['und_mnd_cd'], $this->f062['und_mnd_nm'],
                $this->f062['shpr_nm'], $codigoProvinciaRevision['nombre'],
                'enviado');
            
                $controladorImportacionMuestras->eliminarProductosImportacionMuestras($conexionGUIA,pg_fetch_result($importacionMuestra, 0, 'id_importacion_muestras'));
        }
        
        echo OUT_MSG . 'Datos de cabecera de importacion de muestras insertadas';
        
        
        for ($i = 0; $i < count ($this->f062pd); $i++) {
            
            $controladorImportacionMuestras -> guardarImportacionMuestrasProductos($conexionGUIA, 
                pg_fetch_result($importacionMuestra, 0, 'id_importacion_muestras'), $this->f062['req_no'], $this->f062pd[$i]['hc'], 
                $this->f062pd[$i]['nm_pdt'], $this->f062pd[$i]['cnt_pdt'], $this->f062pd[$i]['und_md_pdt'], 
                $this->f062pd[$i]['weg_pdt'], $this->f062pd[$i]['weg_und'], 
                $this->f062pd[$i]['fob_val'], $this->f062pd[$i]['cif_val']);            
        }
        
        
        echo OUT_MSG . 'Datos de detalle de productos de importacion de muestras insertados';
    ...
    public function insertarDocumentosAdjuntosGUIA($documentos){
        ...
        $idImportacion = pg_fetch_result($controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorImportador, $this->f062['req_no']),0,'id_importacion_muestras');
        
        $controladorImportacionMuestras->eliminarArchivosAdjuntos($conexionGUIA, $idImportacion, $this->f062['req_no']);
        
        if(pg_num_rows($documentos)!= 0){
            while($documentosAdjuntos = pg_fetch_assoc($documentos)){
                $ruta= explode(RUTA_CORTA_ARCHIVOS_VUE, $documentosAdjuntos['ruta']);
                //$ruta= explode('PROD/', $documentosAdjuntos['ruta']);
                $controladorImportacionMuestras ->guardarImportacionMuestrasArchivos($conexionGUIA, $idImportacion, $documentosAdjuntos['nombre'], $ruta[1], $this->f062['req_no']);
            }
        }else{
            echo OUT_MSG . 'La solicitud de importacion de muestras no posee documentos adjuntos.';
        }
        
        echo OUT_MSG . 'Documentos adjuntos de importacion de muestras insertados.';
        
        return true;
    }
    
    //No se requiere por funcionalidad solicitada
    public function actualizarDatosEnGUIA(){
    ...
    public function recaudacionTasa($recaudacionTasas){
        ...
        $importacion = pg_fetch_assoc($controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorImportador, $this->f062['req_no']));
        
        $qFinanciero = $controladorRevisionSolicitudesVUE->buscarIdImposicionTasaXSolicitud($conexionGUIA, $importacion['id_importacion_muestras'], 'ImportacionMuestrasVUE', 'Financiero');
        $financiero = pg_fetch_assoc($qFinanciero);
        ...
        if($verificarProceso){
            ...
            if($financiero['monto'] == $datosTasa['monto_recaudado']){
                ...
                //if( $datosTasa['banco']!='' || $datosTasa['monto_recaudado']!='' || $datosTasa['fecha_contable']!=''){
                $controladorRevisionSolicitudesVUE->guardarInspeccionFinanciero($conexionGUIA, $financiero['id_financiero'], $financiero['identificador_inspector'], 'aprobado', $datosTasa['fecha_recaudacion'], $idBanco, $datosTasa['monto_recaudado'], $banco, $datosTasa['numero_orden_vue'] ,$datosTasa['numero_orden_vue']);
                $controladorFinanciero->actualizarNumeroOrdenSolicitudVue($conexionGUIA, $importacion['id_importacion_muestras'], $financiero['id_grupo'], 'ImportacionMuestrasVUE', $datosTasa['numero_orden_vue']);
                //}
                
                echo OUT_MSG . 'Actualización de datos de tasas de recaudación';
                
                //Asigna el resultado de revisión de pago de solicitud de importacion
                $controladorImportacionMuestras->enviarImportacionMuestras($conexionGUIA, $importacion['id_importacion_muestras'], 'aprobado');
                //$controladorImportaciones->enviarImportacion($conexionGUIA, $importacion['id_importacion'], 'verificacion');
                
                //Asignar fecha de vigencia de solicitud
                $controladorImportacionMuestras->enviarFechaVigenciaImportacionMuestras($conexionGUIA, $importacion['id_importacion_muestras'],$importacion['codigo_tipo_solicitud']);
                
                $cfa->actualizarTipoProcesoFacturaFinancieroAutomaticoCabecera($conexionGUIA, $this->f062['req_no'], $tipoProceso);
    ...
    public function cancelar(){
        ...
        $registroImportacion = $controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorImportador, $this->f062['req_no']);
        
        if(pg_num_rows($registroImportacion)!=0){
            
            $controladorImportacionMuestras->enviarImportacionMuestras($conexionGUIA, pg_fetch_result($registroImportacion, 0, 'id_importacion_muestras'), 'cancelado');
    ...
    public function anular(){
        ...
        if(pg_num_rows($registroImportacion)!=0){
            ...
            $controladorImportacionMuestras->enviarImportacionMuestras($conexionGUIA, pg_fetch_result($registroImportacion, 0, 'id_importacion_muestras'), 'anulado');
    ...
    public function reversoSolicitud(){
        ...
        $identificadorImportador = $this->f062['impr_idt_no'];
        $idImportacion = pg_fetch_assoc($controladorImportacionMuestras->buscarImportacionMuestrasVUE($conexionGUIA, $identificadorImportador, $this->f062['req_no']));
        
        $qFinanciero = $controladorRevisionSolicitudesVUE->buscarIdImposicionTasaXSolicitudReverso($conexionGUIA, $idImportacion['id_importacion_muestras'], 'ImportacionMuestrasVUE', 'Financiero');
        $financiero = pg_fetch_assoc($qFinanciero);
        
        $controladorRevisionSolicitudesVUE->actualizarInspeccionFinancieroMontoRecaudado($conexionGUIA, $financiero['id_financiero']);
        
        $controladorImportacionMuestras->enviarImportacionMuestras($conexionGUIA, $idImportacion['id_importacion_muestras'], 'reverso');
        
        $cfa->actualizarEstadoFinancieroAutomaticoCabeceraPorIdVue($conexionGUIA, $this->f062['req_no'], 'Reverso');
    ...
    public function generarFacturaProcesoAutomatico(){
        ...
        $cfa->actualizarEstadoFacturaFinancieroAutomaticoCabecera($conexionGUIA, $this->f062['req_no'], 'Por atender');
        $cfa->actualizarFechaFacturaFinancieroAutomaticoCabecera($conexionGUIA, $this->f062['req_no']);
        
        echo OUT_MSG . 'Solicitud de Importacion de Muestras enviada a verificación de pago.';
