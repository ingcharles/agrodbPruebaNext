...
class ControladorSolicitudes{
	...
	public function eliminarSolicitud ($conexion,$idSolicitud, $observacion){
	    
	    
	    $res = $conexion->ejecutarConsulta("update 	g_solicitudes.solicitudes
											set     condicion = 'eliminado',
													observacion = '".$observacion."'
											where 	id_solicitud = '".$idSolicitud."';");
	    return $res;
	}
	
	public function eliminarRevisoresSolicitud ($conexion,$idSolicitud){
