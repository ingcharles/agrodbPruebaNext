...
class ControladorModificacionProductoRia
{
    ...
    public function abrirDetalleSolicitudProducto ($conexion, $idSolicitud){
        ...
        $res = $conexion->ejecutarConsulta("SELECT
											...
											WHERE
												id_solicitud_producto =  $idSolicitud;");
        return $res;
    }
    
	public function obtenerDatosSolicitudProvincia ($conexion, $idSolicitud){
