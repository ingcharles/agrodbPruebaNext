...
<!-- link
	...
	<link rel='stylesheet' href='aplicaciones/general/estilos/agrodb.css?version=1.1'>
...
<script src="aplicaciones/general/funciones/agrdbfunc.js?version=1.2" type="text/javascript"></script>
...
<script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyD4ugaXa_glSLEsmkfltSYgczK9FmulRFA'></script>
<?php 
	/*if(!isset($_SESSION['tipoEmpleado'])){
		echo $cco->cargarPopup('', '', '', 'texto-popup-titulo-medio','texto-popup-subtitulo-medio','texto-popup-mensaje-medio','aplicaciones/general/img/calidad3.png','estilo-popup-imagen');
		echo '<footer class="contenedorTh" id="contenedorTh">
		<div class="imagenTh" ><a title="Encuesta de satisfacción al servicio" href="https://www.agrocalidad.gob.ec/landing/?page_id=80" target="_blank"><img src="aplicaciones/general/img/lateral.jpg" alt="Encuesta" /></a></div>
		</footer>';
	}*/
?>
<script type="text/javascript">
	...
	function iniciarChat(){
		if (tipoEmpleado != "" && auxChat == "SI"){			
			...
			setInterval(cargarContactos, 60000);
